...
#define ZMP_DRV_CONTROLLED() ((_drvInf.mode == MODE_PROGRAM && _drvInf.servo == SERVO_MODE_ON) ? 1 : 0)
...
#define ZMP_STR_CONTROLLED() ((_strInf.mode == MODE_PROGRAM && _strInf.servo == SERVO_MODE_ON) ? 1 : 0)
