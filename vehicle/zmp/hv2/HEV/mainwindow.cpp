...
//    this->addToolBar(getToolBar(this));
    ...
    connect(ui->pushButton_brakeLampOn, SIGNAL(clicked()), this, SLOT(sndBrkLampOn()));
    connect(ui->pushButton_brakeLampOff, SIGNAL(clicked()), this, SLOT(sndBrkLampOff()));
    connect(ui->pushButton_brakeModeOn, SIGNAL(clicked()), this, SLOT(sndBrkModeOn()));
    connect(ui->pushButton_brakeModeOff, SIGNAL(clicked()), this, SLOT(sndBrkModeOff()));
    connect(ui->pushButton_blinkerLeftOn, SIGNAL(clicked()), this, SLOT(sndBlinkerLeftOn()));
    connect(ui->pushButton_blinkerLeftOff, SIGNAL(clicked()), this, SLOT(sndBlinkerLeftOff()));
    connect(ui->pushButton_blinkerRightOn, SIGNAL(clicked()), this, SLOT(sndBlinkerRightOn()));
    connect(ui->pushButton_blinkerRightOff, SIGNAL(clicked()), this, SLOT(sndBlinkerRightOff()));
