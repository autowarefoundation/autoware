...
TEST(TestSuite, box3DToDetectedObject)
{
  ...
  // Test case 1: Test with valid label
  {
    ...
    lidar_transfusion::box3DToDetectedObject(box3d, class_names, obj);
