...
Real LimitsConfig::Extremum::min() const noexcept { return m_min; }
Real LimitsConfig::Extremum::max() const noexcept { return m_max; }
...
LimitsConfig::Extremum LimitsConfig::jerk() const noexcept { return m_jerk_limits_mps3; }
...
LimitsConfig::Extremum LimitsConfig::yaw_rate() const noexcept { return m_yaw_rate_limits_rps; }
...
Real VehicleConfig::length_cg_front_axel() const noexcept { return m_length_cg_to_front_axel_m; }
Real VehicleConfig::length_cg_rear_axel() const noexcept { return m_length_cg_to_rear_axel_m; }
...
Real VehicleConfig::mass() const noexcept { return m_mass_kg; }
Real VehicleConfig::inertia() const noexcept { return m_inertia_kgm2; }
Real VehicleConfig::width() const noexcept { return m_width_m; }
Real VehicleConfig::front_overhang() const noexcept { return m_front_overhang_m; }
Real VehicleConfig::rear_overhang() const noexcept { return m_rear_overhang_m; }
...
Real StateWeight::pose() const noexcept { return m_pose_weight; }

Real StateWeight::heading() const noexcept { return m_heading_weight; }

Real StateWeight::longitudinal_velocity() const noexcept { return m_longitudinal_velocity_weight; }

Real StateWeight::lateral_velocity() const noexcept { return m_lateral_velocity_weight; }

Real StateWeight::yaw_rate() const noexcept { return m_yaw_rate_weight; }

Real StateWeight::acceleration() const noexcept { return m_acceleration_weight; }

Real StateWeight::steer_angle() const noexcept { return m_steer_angle_weight; }

Real StateWeight::steer_angle_rate() const noexcept { return m_steer_angle_rate_weight; }

Real StateWeight::jerk() const noexcept { return m_jerk_weight; }
...
StateWeight OptimizationConfig::nominal() const noexcept { return m_nominal_weights; }

StateWeight OptimizationConfig::terminal() const noexcept { return m_terminal_weights; }
}  // namespace motion_common
}  // namespace motion
