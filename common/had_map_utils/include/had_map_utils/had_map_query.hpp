...
lanelet::Polygons3d HAD_MAP_UTILS_PUBLIC
subtypePolygons(const lanelet::Polygons3d polygons, const char subtype[]);

lanelet::LineStrings3d HAD_MAP_UTILS_PUBLIC getLineStringLayer(const lanelet::LaneletMapPtr ll_map);

lanelet::LineStrings3d HAD_MAP_UTILS_PUBLIC
subtypeLineStrings(const lanelet::LineStrings3d linestrings, const char subtype[]);

lanelet::ConstLanelets HAD_MAP_UTILS_PUBLIC
getConstLaneletLayer(const std::shared_ptr<lanelet::LaneletMap> & ll_map);

lanelet::Lanelets HAD_MAP_UTILS_PUBLIC
getLaneletLayer(const std::shared_ptr<lanelet::LaneletMap> & ll_map);
