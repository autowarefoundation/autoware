...
$ wget -P ~/autoware_data/image_projection_based_fusion/ \
       ...
       https://awf.ml.dev.web.auto/perception/models/pointpainting/v4/pointpainting.param.yaml \
...
$ wget -P ~/autoware_data/lidar_centerpoint/ \
       ...
       https://awf.ml.dev.web.auto/perception/models/centerpoint/v2/centerpoint.param.yaml \
       https://awf.ml.dev.web.auto/perception/models/centerpoint/v2/detection_class_remapper.param.yaml \
       https://awf.ml.dev.web.auto/perception/models/centerpoint/v2/centerpoint_tiny.param.yaml \
