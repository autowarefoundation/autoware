...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.6.8 on Wed Aug 19 21:13:14 2015
#
...
class MyFrame(wx.Frame):
	def __init__(self, *args, **kwds):
		...
		self.panel_stdout = wx.ScrolledWindow(self.tab_status, wx.ID_ANY, style=wx.TAB_TRAVERSAL)
		self.label_stdout = wx.StaticText(self.panel_stdout, wx.ID_ANY, "")
		self.sizer_87_copy_staticbox = wx.StaticBox(self.tab_status, wx.ID_ANY, _("Stdout, Stderr"))
		...
		self.tab_topic = wx.Panel(self.notebook_1, wx.ID_ANY)
		self.panel_topic_list = wx.ScrolledWindow(self.tab_topic, wx.ID_ANY, style=wx.TAB_TRAVERSAL)
		self.panel_topic_echo = wx.ScrolledWindow(self.tab_topic, wx.ID_ANY, style=wx.TAB_TRAVERSAL)
		self.label_topic_echo = wx.StaticText(self.panel_topic_echo, wx.ID_ANY, "")
		self.sizer_35_staticbox = wx.StaticBox(self.tab_topic, wx.ID_ANY, _("Echo"))
		self.panel_topic_info = wx.ScrolledWindow(self.tab_topic, wx.ID_ANY, style=wx.TAB_TRAVERSAL)
		self.label_topic_info = wx.StaticText(self.panel_topic_info, wx.ID_ANY, "")
		self.sizer_36_staticbox = wx.StaticBox(self.tab_topic, wx.ID_ANY, _("Info"))
		self.button_refresh_topic = wx.Button(self.tab_topic, wx.ID_ANY, _("Refresh"))
		self.button_rosbag_topic = wx.ToggleButton(self.tab_topic, wx.ID_ANY, _("ROSBAG"))
		self.button_rviz_topic = wx.ToggleButton(self.tab_topic, wx.ID_ANY, _("Rviz"))
		self.button_rqt_topic = wx.ToggleButton(self.tab_topic, wx.ID_ANY, _("RQT"))
		self.label_cpuinfo = wx.StaticText(self, wx.ID_ANY, "")
		...
		self.Bind(wx.EVT_BUTTON, self.OnRefreshTopic, self.button_refresh_topic)
		self.Bind(wx.EVT_TOGGLEBUTTON, self.OnRosbagRecord, self.button_rosbag_topic)
		self.Bind(wx.EVT_TOGGLEBUTTON, self.OnLaunchKill, self.button_rviz_topic)
		self.Bind(wx.EVT_TOGGLEBUTTON, self.OnLaunchKill, self.button_rqt_topic)
		# end wxGlade
	...
	def __set_properties(self):
		...
		self.panel_stdout.SetScrollRate(10, 10)
		self.panel_topic_list.SetScrollRate(10, 10)
		self.panel_topic_echo.SetScrollRate(10, 10)
		self.panel_topic_info.SetScrollRate(10, 10)
		# end wxGlade
	...
	def __do_layout(self):
		...
		sizer_topic_info = wx.BoxSizer(wx.VERTICAL)
		self.sizer_35_staticbox.Lower()
		sizer_35 = wx.StaticBoxSizer(self.sizer_35_staticbox, wx.HORIZONTAL)
		sizer_topic_echo = wx.BoxSizer(wx.VERTICAL)
		self.sizer_topic_list = wx.BoxSizer(wx.VERTICAL)
		...
		self.sizer_87_copy_staticbox.Lower()
		sizer_87_copy = wx.StaticBoxSizer(self.sizer_87_copy_staticbox, wx.HORIZONTAL)
		sizer_87_copy_1 = wx.BoxSizer(wx.HORIZONTAL)
		...
		sizer_87_copy_1.Add(self.label_stdout, 1, wx.ALL, 4)
		self.panel_stdout.SetSizer(sizer_87_copy_1)
		sizer_87_copy.Add(self.panel_stdout, 1, wx.EXPAND, 0)
		sizer_20.Add(sizer_87_copy, 1, wx.EXPAND, 0)
		...
		self.panel_topic_list.SetSizer(self.sizer_topic_list)
		sizer_32.Add(self.panel_topic_list, 1, wx.EXPAND, 0)
		sizer_topic_echo.Add(self.label_topic_echo, 0, 0, 0)
		self.panel_topic_echo.SetSizer(sizer_topic_echo)
		sizer_35.Add(self.panel_topic_echo, 1, wx.EXPAND, 0)
		sizer_34.Add(sizer_35, 1, wx.EXPAND, 0)
		sizer_topic_info.Add(self.label_topic_info, 0, 0, 0)
		self.panel_topic_info.SetSizer(sizer_topic_info)
		sizer_36.Add(self.panel_topic_info, 1, wx.EXPAND, 0)
		sizer_34.Add(sizer_36, 1, wx.EXPAND, 0)
		sizer_32.Add(sizer_34, 1, wx.EXPAND, 0)
		sizer_85_copy.Add(sizer_32, 1, wx.EXPAND, 0)
		sizer_60_copy_copy.Add(self.button_refresh_topic, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 4)
		sizer_51_copy_copy.Add(sizer_60_copy_copy, 1, wx.EXPAND, 0)
		sizer_52_copy_1_copy.Add(self.button_rosbag_topic, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 4)
		sizer_52_copy_1_copy.Add(self.button_rviz_topic, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 4)
		sizer_52_copy_1_copy.Add(self.button_rqt_topic, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 4)
		sizer_51_copy_copy.Add(sizer_52_copy_1_copy, 0, wx.EXPAND, 0)
		sizer_85_copy.Add(sizer_51_copy_copy, 0, wx.EXPAND, 0)
		self.tab_topic.SetSizer(sizer_85_copy)
		...
		self.notebook_1.AddPage(self.tab_topic, _("Topic"))
		self.sizer_1.Add(self.notebook_1, 1, wx.EXPAND, 0)
		sizer_29.Add((0, 50), 0, wx.EXPAND, 0)
		sizer_29.Add(self.label_cpuinfo, 1, wx.ALL | wx.EXPAND, 4)
	...
	def OnRefreshTopic(self, event):  # wxGlade: MyFrame.<event_handler>
		print "Event handler 'OnRefreshTopic' not implemented!"
		event.Skip()
