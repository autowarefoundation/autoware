...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.6.8 on Fri Mar  6 17:54:43 2015
#
...
class MyFrame(wx.Frame):
	def __init__(self, *args, **kwds):
		...
		self.text_ctrl_file_tf = wx.TextCtrl(self.notebook_1_pane_5, wx.ID_ANY, "", style=wx.TE_PROCESS_ENTER)
		self.button_ref_file_tf = wx.Button(self.notebook_1_pane_5, wx.ID_ANY, _("Ref"))
		...
		self.text_ctrl_dir_sensor_fusion = wx.TextCtrl(self.notebook_1_pane_5, wx.ID_ANY, "")
		self.button_ref_dir_sensor_fusion = wx.Button(self.notebook_1_pane_5, wx.ID_ANY, _("Ref"))
		...
		self.panel_pmap_prm = wx.Panel(self.panel_3, wx.ID_ANY)
		...
		self.Bind(wx.EVT_TEXT_ENTER, self.OnAliasSync, self.text_ctrl_file_tf)
		self.Bind(wx.EVT_BUTTON, self.OnRef, self.button_ref_file_tf)
		self.Bind(wx.EVT_BUTTON, self.OnLaunch, self.button_launch_tf)
		self.Bind(wx.EVT_BUTTON, self.OnKill, self.button_kill_tf)
		self.Bind(wx.EVT_BUTTON, self.OnRef, self.button_ref_dir_sensor_fusion)
	...
	def __set_properties(self):
		...
		self.button_ref_file_tf.SetMinSize((40, 29))
		self.button_kill_tf.SetMinSize((40, 29))
		self.button_kill_tf.Enable(False)
		self.button_ref_dir_sensor_fusion.SetMinSize((40, 29))
	...
	def __do_layout(self):
		...
		sizer_28.Add(self.text_ctrl_file_tf, 1, wx.LEFT | wx.TOP, 4)
		sizer_28.Add(self.button_ref_file_tf, 0, wx.LEFT | wx.RIGHT | wx.TOP, 4)
		...
		sizer_28_copy.Add(self.text_ctrl_dir_sensor_fusion, 1, wx.LEFT | wx.TOP, 4)
		sizer_28_copy.Add(self.button_ref_dir_sensor_fusion, 0, wx.LEFT | wx.RIGHT | wx.TOP, 4)
		...
		sizer_28_copy_copy_copy.Add(self.panel_pmap_prm, 1, wx.EXPAND, 0)
