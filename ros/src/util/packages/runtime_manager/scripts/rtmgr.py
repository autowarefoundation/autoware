...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.6.8 on Tue Feb  2 13:29:08 2016
#
...
class MyFrame(wx.Frame):
	def __init__(self, *args, **kwds):
		...
		self.Bind(wx.EVT_TOGGLEBUTTON, self.OnRosbagRecord, self.button_rosbag_computing_copy)
		self.Bind(wx.EVT_TOGGLEBUTTON, self.OnLaunchKill, self.button_rviz_computing_copy)
		self.Bind(wx.EVT_TOGGLEBUTTON, self.OnLaunchKill, self.button_rqt_computing_copy)
	...
	def __do_layout(self):
		...
		sizer_52_copy_copy_copy_copy_1.Add(self.button_rosbag_computing_copy, 0, wx.ALL, 4)
		sizer_52_copy_copy_copy_copy_1.Add(self.button_rviz_computing_copy, 0, wx.ALL, 4)
		sizer_52_copy_copy_copy_copy_1.Add(self.button_rqt_computing_copy, 0, wx.ALL, 4)
...
class MyDialogLaneStop(wx.Dialog):
	def __init__(self, *args, **kwds):
		...
		self.Bind(wx.EVT_CHECKBOX, self.OnLaneStop, self.checkbox_lane_stop)
		self.Bind(wx.EVT_BUTTON, self.OnOk, self.button_1)
		self.Bind(wx.EVT_BUTTON, self.OnCancel, self.button_1_copy)
		# end wxGlade
	...
	def OnLaneStop(self, event):  # wxGlade: MyDialogLaneStop.<event_handler>
		print "Event handler 'OnLaneStop' not implemented!"
		event.Skip()
