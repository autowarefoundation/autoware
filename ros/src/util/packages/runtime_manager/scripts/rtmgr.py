...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.6.8 on Mon Jul  6 17:55:27 2015
#
...
class MyFrame(wx.Frame):
	def __init__(self, *args, **kwds):
		...
		self.label_map_qs = wx.StaticText(self.tab_qs, wx.ID_ANY, _("OK"), style=wx.ALIGN_CENTRE)
		...
		self.label_sensing_qs = wx.StaticText(self.tab_qs, wx.ID_ANY, _("OK"), style=wx.ALIGN_CENTRE)
		...
		self.label_localization_qs = wx.StaticText(self.tab_qs, wx.ID_ANY, _("82 ms"), style=wx.ALIGN_CENTRE)
		...
		self.label_detection_qs = wx.StaticText(self.tab_qs, wx.ID_ANY, _("196 ms"), style=wx.ALIGN_CENTRE)
		...
		self.label_mission_planning_qs = wx.StaticText(self.tab_qs, wx.ID_ANY, _("91 ms"), style=wx.ALIGN_CENTRE)
		...
		self.label_motion_planning_qs = wx.StaticText(self.tab_qs, wx.ID_ANY, _("101 ms"), style=wx.ALIGN_CENTRE)
		...
		self.label_2 = wx.StaticText(self.tab_qs, wx.ID_ANY, _("cpu load info"))
		...
		self.label_3 = wx.StaticText(self.tab_map, wx.ID_ANY, _("Loading bar ... 82%"), style=wx.ALIGN_CENTRE)
		self.label_point_cloud = wx.StaticText(self.tab_map, wx.ID_ANY, _("OK"), style=wx.ALIGN_CENTRE)
		...
		self.tab_socket = wx.Panel(self.notebook_1, wx.ID_ANY)
		self.button_android_tablet_socket = wx.ToggleButton(self.tab_socket, wx.ID_ANY, _("Android Tablet"))
		self.button_oculus_rift_socket = wx.ToggleButton(self.tab_socket, wx.ID_ANY, _("Oculus Rift"))
		self.button_vehicle_gateway_socket = wx.ToggleButton(self.tab_socket, wx.ID_ANY, _("Vehicle Gateway"))
		self.sizer_25_staticbox = wx.StaticBox(self.tab_socket, wx.ID_ANY, "")
		self.button_auto_pilot_socket = wx.ToggleButton(self.tab_socket, wx.ID_ANY, _("Auto Pilot"))
		self.label_5 = wx.StaticText(self.tab_socket, wx.ID_ANY, _("Lamp"))
		self.button_statchk_lamp_l = wx.ToggleButton(self.tab_socket, wx.ID_ANY, _("L"))
		self.button_statchk_lamp_r = wx.ToggleButton(self.tab_socket, wx.ID_ANY, _("R"))
		self.label_5_copy = wx.StaticText(self.tab_socket, wx.ID_ANY, _("Indicator"))
		self.button_statchk_indi_l = wx.ToggleButton(self.tab_socket, wx.ID_ANY, _("L"))
		self.button_statchk_indi_r = wx.ToggleButton(self.tab_socket, wx.ID_ANY, _("R"))
		self.button_statchk_d = wx.ToggleButton(self.tab_socket, wx.ID_ANY, _("D"))
		self.button_statchk_r = wx.ToggleButton(self.tab_socket, wx.ID_ANY, _("R"))
		self.button_statchk_b = wx.ToggleButton(self.tab_socket, wx.ID_ANY, _("B"))
		self.button_statchk_n = wx.ToggleButton(self.tab_socket, wx.ID_ANY, _("N"))
		self.panel_socket_cc = wx.Panel(self.tab_socket, wx.ID_ANY)
		self.sizer_26_staticbox = wx.StaticBox(self.tab_socket, wx.ID_ANY, "")
		self.button_rosbag_socket = wx.ToggleButton(self.tab_socket, wx.ID_ANY, _("ROSBAG"))
		self.button_rviz_socket = wx.ToggleButton(self.tab_socket, wx.ID_ANY, _("Rviz"))
		...
		self.label_rosbag_play_pos = wx.StaticText(self.tab_simulation, wx.ID_ANY, _("1593"))
		self.static_line_3 = wx.StaticLine(self.tab_simulation, wx.ID_ANY)
		self.label_rosbag_play_total = wx.StaticText(self.tab_simulation, wx.ID_ANY, _("1932"))
		...
		self.tab_main = wx.Panel(self.notebook_1, wx.ID_ANY)
		self.bitmap_tablet = wx.StaticBitmap(self.tab_main, wx.ID_ANY, wx.NullBitmap)
		self.bitmap_mobile = wx.StaticBitmap(self.tab_main, wx.ID_ANY, wx.NullBitmap)
		self.bitmap_vehicle = wx.StaticBitmap(self.tab_main, wx.ID_ANY, wx.NullBitmap)
		self.bitmap_database = wx.StaticBitmap(self.tab_main, wx.ID_ANY, wx.NullBitmap)
		self.label_9 = wx.StaticText(self.tab_main, wx.ID_ANY, _("Tablet UI"))
		self.label_9_copy = wx.StaticText(self.tab_main, wx.ID_ANY, _("Mobile UI"))
		self.label_9_copy_1 = wx.StaticText(self.tab_main, wx.ID_ANY, _("Vehicle Control"))
		self.label_9_copy_2 = wx.StaticText(self.tab_main, wx.ID_ANY, _("Database Access"))
		self.button_tablet = wx.ToggleButton(self.tab_main, wx.ID_ANY, _("Active"))
		self.button_mobile = wx.ToggleButton(self.tab_main, wx.ID_ANY, _("Active"))
		self.button_vehicle = wx.ToggleButton(self.tab_main, wx.ID_ANY, _("Active"))
		self.button_database = wx.ToggleButton(self.tab_main, wx.ID_ANY, _("Active"))
		self.sizer_50_staticbox = wx.StaticBox(self.tab_main, wx.ID_ANY, _("Network Connection"))
		self.panel_simulation = wx.ScrolledWindow(self.tab_main, wx.ID_ANY, style=wx.TAB_TRAVERSAL)
		self.checkbox_point_map_update = wx.CheckBox(self.tab_main, wx.ID_ANY, _("Point Map Update"))
		self.panel_3 = wx.ScrolledWindow(self.tab_main, wx.ID_ANY, style=wx.TAB_TRAVERSAL)
		...
		self.button_launch_rosbag_play_ = wx.Button(self.panel_3, wx.ID_ANY, _("ROSBAG Play"))
		self.button_kill_rosbag_play_ = wx.Button(self.panel_3, wx.ID_ANY, _("Kill"))
		self.button_pause_rosbag_play_ = wx.Button(self.panel_3, wx.ID_ANY, _("Pause"))
		...
		self.button_statchk_prog = wx.ToggleButton(self.tab_main, wx.ID_ANY, _("Program"))
		self.button_statchk_manu = wx.ToggleButton(self.tab_main, wx.ID_ANY, _("Manual"))
		self.label_12 = wx.StaticText(self.tab_main, wx.ID_ANY, _("Indicator"))
		self.panel_main_cc = wx.Panel(self.tab_main, wx.ID_ANY)
		self.sizer_65_staticbox = wx.StaticBox(self.tab_main, wx.ID_ANY, _("Control Check"))
		self.text_ctrl_way_point = wx.TextCtrl(self.tab_main, wx.ID_ANY, "")
		self.text_ctrl_point_cloud = wx.TextCtrl(self.tab_main, wx.ID_ANY, "")
		self.text_ctrl_vector_map = wx.TextCtrl(self.tab_main, wx.ID_ANY, "")
		self.text_ctrl_area_list = wx.TextCtrl(self.tab_main, wx.ID_ANY, "")
		self.button_ref_way_point = wx.Button(self.tab_main, wx.ID_ANY, _("Ref"))
		self.button_ref_point_cloud = wx.Button(self.tab_main, wx.ID_ANY, _("Ref"))
		self.button_ref_vector_map = wx.Button(self.tab_main, wx.ID_ANY, _("Ref"))
		self.button_ref_area_list = wx.Button(self.tab_main, wx.ID_ANY, _("Ref"))
		self.checkbox_auto_ignore_db = wx.CheckBox(self.tab_main, wx.ID_ANY, _("Ignore DB"))
		self.checkbox_auto_ignore_navi = wx.CheckBox(self.tab_main, wx.ID_ANY, _("IgnoreNavi"))
		self.button_load_map = wx.ToggleButton(self.tab_main, wx.ID_ANY, _("Map"))
		self.sizer_55_staticbox = wx.StaticBox(self.tab_main, wx.ID_ANY, _("Route and Map"))
		self.text_ctrl_main_tf = wx.TextCtrl(self.tab_main, wx.ID_ANY, "", style=wx.TE_PROCESS_ENTER)
		self.button_ref_main_tf = wx.Button(self.tab_main, wx.ID_ANY, _("Ref"))
		self.text_ctrl_main_rosbag_play = wx.TextCtrl(self.tab_main, wx.ID_ANY, "", style=wx.TE_PROCESS_ENTER)
		self.button_ref_main_rosbag_play = wx.Button(self.tab_main, wx.ID_ANY, _("Ref"))
		self.label_4_copy = wx.StaticText(self.tab_main, wx.ID_ANY, _("Rate"))
		self.text_ctrl_rate_main_rosbag_play = wx.TextCtrl(self.tab_main, wx.ID_ANY, "", style=wx.TE_PROCESS_ENTER)
		self.checkbox_clock_main_rosbag_play = wx.CheckBox(self.tab_main, wx.ID_ANY, _("Clock"))
		self.checkbox_main_sim_time = wx.CheckBox(self.tab_main, wx.ID_ANY, _("Simulation Time"))
		self.button_main_tf = wx.ToggleButton(self.tab_main, wx.ID_ANY, _("TF"))
		self.button_launch_main_rosbag_play = wx.Button(self.tab_main, wx.ID_ANY, _("Play"))
		self.button_kill_main_rosbag_play = wx.Button(self.tab_main, wx.ID_ANY, _("Stop"))
		self.button_pause_main_rosbag_play = wx.Button(self.tab_main, wx.ID_ANY, _("Pause"))
		self.button_main_rosbag_record = wx.Button(self.tab_main, wx.ID_ANY, _("Record"))
		self.sizer_19_staticbox = wx.StaticBox(self.tab_main, wx.ID_ANY, _("ROS"))
		self.button_sensor = wx.ToggleButton(self.tab_main, wx.ID_ANY, _("Sensor"))
		self.button_map = wx.ToggleButton(self.tab_main, wx.ID_ANY, _("Map"))
		self.button_perception = wx.ToggleButton(self.tab_main, wx.ID_ANY, _("Perception"))
		self.button_planning = wx.ToggleButton(self.tab_main, wx.ID_ANY, _("Planning"))
		self.button_control = wx.ToggleButton(self.tab_main, wx.ID_ANY, _("Control"))
		self.label_gnss_stat = wx.StaticText(self.tab_main, wx.ID_ANY, _("GNSS"))
		self.label_map_stat = wx.StaticText(self.tab_main, wx.ID_ANY, _("MAP"))
		self.label_ndt_stat = wx.StaticText(self.tab_main, wx.ID_ANY, _("NDT"))
		self.label_lf_stat = wx.StaticText(self.tab_main, wx.ID_ANY, _("Lane Follow"))
		self.button_drive = wx.ToggleButton(self.tab_main, wx.ID_ANY, _("Drive"))
		self.button_clear = wx.Button(self.tab_main, wx.ID_ANY, _("Clear"))
		...
		self.Bind(wx.EVT_TOGGLEBUTTON, self.OnLaunchKill, self.button_auto_pilot_qs)
		...
		self.Bind(wx.EVT_TOGGLEBUTTON, self.OnLaunchKill, self.button_calibration_publisher)
		...
		self.Bind(wx.EVT_TOGGLEBUTTON, self.OnLaunchKill, self.button_android_tablet_socket)
		self.Bind(wx.EVT_TOGGLEBUTTON, self.OnLaunchKill, self.button_oculus_rift_socket)
		self.Bind(wx.EVT_TOGGLEBUTTON, self.OnLaunchKill, self.button_vehicle_gateway_socket)
		self.Bind(wx.EVT_TOGGLEBUTTON, self.OnLaunchKill, self.button_auto_pilot_socket)
		...
		self.Bind(wx.EVT_TOGGLEBUTTON, self.OnRosbagRecord, self.button_rosbag_socket)
		self.Bind(wx.EVT_TOGGLEBUTTON, self.OnLaunchKill, self.button_rviz_socket)
		...
		self.Bind(wx.EVT_BUTTON, self.OnLaunch, self.button_launch_rosbag_play_)
		self.Bind(wx.EVT_BUTTON, self.OnKill, self.button_kill_rosbag_play_)
		self.Bind(wx.EVT_BUTTON, self.OnPauseRosbagPlay, self.button_pause_rosbag_play_)
	...
	def __set_properties(self):
		...
		self.button_kill_rosbag_play_.SetMinSize((40, 29))
		self.button_kill_rosbag_play_.Enable(False)
		self.button_pause_rosbag_play_.SetMinSize((60, 29))
		self.button_pause_rosbag_play_.Enable(False)
	...
	def __do_layout(self):
		...
		sizer_60.Add(self.label_2, 1, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 4)
		sizer_51.Add(sizer_60, 1, wx.EXPAND, 0)
		sizer_52.Add(self.button_rosbag_qs, 0, wx.ALL, 4)
		sizer_52.Add(self.button_rviz_qs, 0, wx.ALL, 4)
		...
		sizer_64.Add(self.label_3, 1, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 4)
		sizer_64.Add(self.label_point_cloud, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 4)
		...
		sizer_61.Add(sizer_53_copy_3_copy, 0, wx.TOP | wx.BOTTOM | wx.EXPAND, 4)
		...
		sizer_4.Add(sizer_61, 0, wx.EXPAND, 0)
		...
		sizer_33.Add(self.panel_sensing, 0, 0, 0)
		...
		sizer_7.Add(sizer_69, 2, wx.TOP | wx.BOTTOM | wx.EXPAND, 20)
		...
		sizer_7.Add(sizer_70, 3, wx.TOP | wx.BOTTOM | wx.EXPAND, 20)
		...
		sizer_62_copy_copy.Add((20, 20), 1, 0, 0)
		...
		sizer_25.Add(self.button_android_tablet_socket, 1, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 4)
		sizer_25.Add(self.button_oculus_rift_socket, 1, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 4)
		sizer_25.Add(self.button_vehicle_gateway_socket, 1, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 4)
		sizer_24.Add(sizer_25, 0, wx.ALL | wx.EXPAND, 4)
		sizer_72.Add(self.button_auto_pilot_socket, 1, wx.ALL | wx.EXPAND, 4)
		...
		sizer_77.Add(self.panel_socket_cc, 1, wx.ALL, 4)
		...
		sizer_52_copy_copy_copy_copy.Add(self.button_rosbag_socket, 0, wx.ALL, 4)
		sizer_52_copy_copy_copy_copy.Add(self.button_rviz_socket, 0, wx.ALL, 4)
		sizer_62_copy_copy_copy.Add(sizer_52_copy_copy_copy_copy, 0, wx.EXPAND, 0)
		sizer_24.Add(sizer_62_copy_copy_copy, 0, wx.EXPAND, 0)
		self.tab_socket.SetSizer(sizer_24)
		...
		sizer_83.Add(self.label_rosbag_play_pos, 0, wx.ALIGN_CENTER_VERTICAL, 0)
		sizer_83.Add(self.static_line_3, 0, wx.EXPAND, 0)
		sizer_83.Add(self.label_rosbag_play_total, 0, wx.ALIGN_CENTER_VERTICAL, 0)
		...
		sizer_8.Add(self.button_launch_rosbag_play_, 0, wx.ALL, 4)
		sizer_8.Add(self.button_kill_rosbag_play_, 0, wx.ALL, 4)
		sizer_8.Add(self.button_pause_rosbag_play_, 0, wx.ALL, 4)
		...
		sizer_65.Add(sizer_5_copy, 1, wx.EXPAND, 0)
		...
		label_10_copy_3 = wx.StaticText(self.tab_main, wx.ID_ANY, _("Way Point:"))
		sizer_28.Add(label_10_copy_3, 0, wx.ALL, 6)
		label_10 = wx.StaticText(self.tab_main, wx.ID_ANY, _("Point Cloud:"))
		sizer_28.Add(label_10, 0, wx.ALL, 6)
		label_10_copy = wx.StaticText(self.tab_main, wx.ID_ANY, _("Vector Map:"))
		sizer_28.Add(label_10_copy, 0, wx.ALL, 6)
		label_10_copy_1 = wx.StaticText(self.tab_main, wx.ID_ANY, _("Area List:"))
		...
		label_10_copy_2 = wx.StaticText(self.tab_main, wx.ID_ANY, _("Transform:"))
		...
		label_10_copy_2_copy = wx.StaticText(self.tab_main, wx.ID_ANY, _("ROSBAG:"))
		...
		self.tab_main.SetSizer(sizer_43)
