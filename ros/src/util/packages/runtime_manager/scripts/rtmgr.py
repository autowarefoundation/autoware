...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.6.8 on Fri Jul  3 16:29:57 2015
#
...
class MyFrame(wx.Frame):
	def __init__(self, *args, **kwds):
		...
		self.checkbox_auto_update = wx.CheckBox(self.tab_main, wx.ID_ANY, _("Auto Update"))
		self.choice_scene_num = wx.Choice(self.tab_main, wx.ID_ANY, choices=[_("1x1"), _("3x3"), _("5x5"), _("7x7"), _("9x9")])
	...
	def __do_layout(self):
		...
		self.notebook_1.AddPage(self.notebook_1_pane_2, _("Main"))
