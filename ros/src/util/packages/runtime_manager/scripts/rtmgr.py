...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.7.1 on Fri Feb 16 11:01:30 2018
#
...
class MyFrame(wx.Frame):
	def __init__(self, *args, **kwds):
		...
		self.apex_report_text = wx.ComboBox(self.tab_interface, wx.ID_ANY, choices=[], style=wx.CB_DROPDOWN)
		...
		self.button_substate_behavior_null_1_copy = wx.Button(self.tab_interface, wx.ID_ANY, _("TrafficLightGreen"))
		...
		self.button_substate_behavior_null_0_copy = wx.Button(self.tab_interface, wx.ID_ANY, _("TrafficLightRed"))
		...
		self.button_auto_pilot_interface_hidden = wx.ToggleButton(self.tab_interface, wx.ID_ANY, _("Auto Pilot"))
		...
		self.Bind(wx.EVT_COMBOBOX, self.OnApexReportSelected, self.apex_report_text)
		...
		self.Bind(wx.EVT_BUTTON, self.OnState, self.button_substate_behavior_null_1_copy)
		...
		self.Bind(wx.EVT_BUTTON, self.OnState, self.button_substate_behavior_null_0_copy)
	...
	def __do_layout(self):
		...
		grid_sizer_2.Add(self.panel_6, 1, 0, 0)
		grid_sizer_2.Add(self.button_auto_pilot_interface, 1, wx.ALL | wx.EXPAND, 4)
		sizer_57.Add(self.apex_report_text, 0, wx.ALIGN_CENTER | wx.ALL, 0)
		sizer_57.Add(self.apex_report_button, 0, wx.ALIGN_CENTER | wx.ALL, 0)
		grid_sizer_2.Add(sizer_57, 1, wx.ALIGN_CENTER, 0)
		...
		grid_sizer_2.Add(self.button_substate_behavior_null_1_copy, 1, wx.ALL | wx.EXPAND, 4)
		grid_sizer_2.Add(self.button_rosbag_toggle, 1, wx.ALL | wx.EXPAND, 4)
		sizer_56.Add(self.button_run_all_sensors, 1, wx.ALL | wx.EXPAND, 0)
		sizer_56.Add(self.button_run_lidar_tracker, 1, wx.ALL | wx.EXPAND, 0)
		grid_sizer_2.Add(sizer_56, 1, wx.ALL | wx.EXPAND, 8)
		grid_sizer_2.Add(self.button_substate_behavior_null_0_copy, 1, wx.ALL | wx.EXPAND, 4)
