...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.6.8 on Wed Aug 19 21:41:46 2015
#
...
class MyFrame(wx.Frame):
	def __init__(self, *args, **kwds):
		...
		self.panel_topics_echo = wx.ScrolledWindow(self.tab_topics, wx.ID_ANY, style=wx.TAB_TRAVERSAL)
		self.label_topics_echo = wx.StaticText(self.panel_topics_echo, wx.ID_ANY, "")
		self.sizer_35_staticbox = wx.StaticBox(self.tab_topics, wx.ID_ANY, _("Echo"))
	...
	def __set_properties(self):
		...
		self.panel_topics_echo.SetScrollRate(10, 10)
	...
	def __do_layout(self):
		...
		sizer_topics_echo = wx.BoxSizer(wx.VERTICAL)
		...
		sizer_topics_echo.Add(self.label_topics_echo, 0, 0, 0)
		self.panel_topics_echo.SetSizer(sizer_topics_echo)
		sizer_35.Add(self.panel_topics_echo, 1, wx.EXPAND, 0)
