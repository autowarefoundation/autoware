...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.7.1 on Thu Oct 19 19:34:26 2017
#
...
class MyFrame(wx.Frame):
	def __init__(self, *args, **kwds):
		...
		self.panel_6 = wx.Panel(self.notebook_1, wx.ID_ANY)
		self.button_mainstate_start = wx.Button(self.panel_6, wx.ID_ANY, _("START"))
		self.button_mainstate_init = wx.Button(self.panel_6, wx.ID_ANY, _("INIT"))
		self.button_mainstate_locate = wx.Button(self.panel_6, wx.ID_ANY, _("LOCATE"))
		self.button_mainstate_drive = wx.Button(self.panel_6, wx.ID_ANY, _("DRIVE"))
		self.button_mainstate_goal = wx.Button(self.panel_6, wx.ID_ANY, _("GOAL"))
		self.button_mainstate_emergency = wx.Button(self.panel_6, wx.ID_ANY, _("EMERGENCY"))
		self.sizer_65_staticbox = wx.StaticBox(self.panel_6, wx.ID_ANY, _("MainState"))
		self.button_substate_acc_accelerate = wx.Button(self.panel_6, wx.ID_ANY, _("Accelerate"))
		self.button_substate_acc_decelerate = wx.Button(self.panel_6, wx.ID_ANY, _("Decelerate"))
		self.button_substate_acc_keep = wx.Button(self.panel_6, wx.ID_ANY, _("Keep"), style=wx.BU_EXACTFIT)
		self.button_substate_acc_stop = wx.Button(self.panel_6, wx.ID_ANY, _("Stop"), style=wx.BU_EXACTFIT)
		self.sizer_74_staticbox = wx.StaticBox(self.panel_6, wx.ID_ANY, _("Accel/Brake"))
		self.button_substate_str_straight = wx.Button(self.panel_6, wx.ID_ANY, _("Straight"))
		self.button_substate_str_left = wx.Button(self.panel_6, wx.ID_ANY, _("Left"))
		self.button_substate_str_right = wx.Button(self.panel_6, wx.ID_ANY, _("Right"))
		self.sizer_84_staticbox = wx.StaticBox(self.panel_6, wx.ID_ANY, _("Steering"))
		self.button_substate_behav_lanechange_left = wx.Button(self.panel_6, wx.ID_ANY, _("Lane Change Left"))
		self.button_substate_behav_lanechange_right = wx.Button(self.panel_6, wx.ID_ANY, _("Lane Change Right"))
		self.button_substate_behav_obstacle_avoidance = wx.Button(self.panel_6, wx.ID_ANY, _("Obstacle Avoidance"))
		self.button_substate_behav_clear = wx.Button(self.panel_6, wx.ID_ANY, _("ClearB"))
		self.sizer_88_staticbox = wx.StaticBox(self.panel_6, wx.ID_ANY, _("Behavior"))
		self.button_substate_percep_detect_obstacle = wx.Button(self.panel_6, wx.ID_ANY, _("Detect Obstacle"))
		self.button_substate_percep_detect_stop_line = wx.Button(self.panel_6, wx.ID_ANY, _("Detect Stop Line"))
		self.button_substate_percep_clear = wx.Button(self.panel_6, wx.ID_ANY, _("Traffic Light Red"))
		self.button_26 = wx.Button(self.panel_6, wx.ID_ANY, _("ClearP"))
		self.sizer_89_staticbox = wx.StaticBox(self.panel_6, wx.ID_ANY, _("Perception"))
		self.sizer_58_staticbox = wx.StaticBox(self.panel_6, wx.ID_ANY, _("SubState"))
		self.current_state_label = wx.StaticText(self.panel_6, wx.ID_ANY, "")
		self.sizer_56_staticbox = wx.StaticBox(self.panel_6, wx.ID_ANY, _("CurrentState"))
		self.sizer_50_staticbox = wx.StaticBox(self.panel_6, wx.ID_ANY, _("State"))
		...
		self.Bind(wx.EVT_BUTTON, self.OnState, self.button_mainstate_start)
		self.Bind(wx.EVT_BUTTON, self.OnState, self.button_mainstate_init)
		self.Bind(wx.EVT_BUTTON, self.OnState, self.button_mainstate_locate)
		self.Bind(wx.EVT_BUTTON, self.OnState, self.button_mainstate_drive)
		self.Bind(wx.EVT_BUTTON, self.OnState, self.button_mainstate_goal)
		self.Bind(wx.EVT_BUTTON, self.OnState, self.button_mainstate_emergency)
		self.Bind(wx.EVT_BUTTON, self.OnState, self.button_substate_acc_accelerate)
		self.Bind(wx.EVT_BUTTON, self.OnState, self.button_substate_acc_decelerate)
		self.Bind(wx.EVT_BUTTON, self.OnState, self.button_substate_acc_keep)
		self.Bind(wx.EVT_BUTTON, self.OnState, self.button_substate_acc_stop)
		...
		self.Bind(wx.EVT_BUTTON, self.OnState, self.button_substate_behav_lanechange_left)
		self.Bind(wx.EVT_BUTTON, self.OnState, self.button_substate_behav_lanechange_right)
		self.Bind(wx.EVT_BUTTON, self.OnState, self.button_substate_behav_obstacle_avoidance)
		self.Bind(wx.EVT_BUTTON, self.OnState, self.button_substate_behav_clear)
		self.Bind(wx.EVT_BUTTON, self.OnState, self.button_substate_percep_detect_obstacle)
		self.Bind(wx.EVT_BUTTON, self.OnState, self.button_substate_percep_detect_stop_line)
		self.Bind(wx.EVT_BUTTON, self.OnState, self.button_substate_percep_clear)
		self.Bind(wx.EVT_BUTTON, self.OnState, self.button_26)
		# end wxGlade

	def __set_properties(self):
		# begin wxGlade: MyFrame.__set_properties
		self.SetTitle(_("Runtime Manager"))
		self.SetSize((806, 628))
		...
		self.button_substate_behav_lanechange_left.SetMinSize((150, 29))
		self.button_substate_behav_lanechange_right.SetMinSize((150, 29))
		self.button_substate_behav_obstacle_avoidance.SetMinSize((150, 29))
		self.button_substate_behav_clear.SetMinSize((150, 29))
		self.button_substate_percep_detect_obstacle.SetMinSize((130, 29))
		self.button_substate_percep_detect_stop_line.SetMinSize((130, 29))
		self.button_substate_percep_clear.SetMinSize((130, 29))
		self.button_26.SetMinSize((130, 29))
		# end wxGlade
	...
	def __do_layout(self):
		...
		sizer_88 = wx.StaticBoxSizer(self.sizer_88_staticbox, wx.VERTICAL)
		...
		sizer_83.Add(self.label_rosbag_play_pos, 0, wx.ALIGN_CENTER, 0)
		sizer_83.Add(self.static_line_3, 0, wx.EXPAND, 0)
		sizer_83.Add(self.label_rosbag_play_total, 0, wx.ALIGN_CENTER, 0)
		...
		sizer_67.Add(self.button_mainstate_start, 0, 0, 0)
		sizer_67.Add(self.button_mainstate_init, 0, 0, 0)
		sizer_67.Add(self.button_mainstate_locate, 0, 0, 0)
		sizer_67.Add(self.button_mainstate_drive, 0, 0, 0)
		sizer_67.Add(self.button_mainstate_goal, 0, 0, 0)
		sizer_67.Add(self.button_mainstate_emergency, 0, 0, 0)
		sizer_65.Add(sizer_67, 1, wx.ADJUST_MINSIZE | wx.ALL | wx.EXPAND, 4)
		sizer_55.Add(sizer_65, 1, wx.ADJUST_MINSIZE | wx.EXPAND | wx.FIXED_MINSIZE, 0)
		sizer_74.Add(self.button_substate_acc_accelerate, 0, wx.ALIGN_CENTER, 0)
		sizer_74.Add(self.button_substate_acc_decelerate, 0, wx.ALIGN_CENTER, 0)
		sizer_74.Add(self.button_substate_acc_keep, 0, wx.ALIGN_CENTER, 0)
		sizer_74.Add(self.button_substate_acc_stop, 0, wx.ALIGN_CENTER, 0)
		sizer_73.Add(sizer_74, 1, wx.ADJUST_MINSIZE | wx.ALIGN_CENTER | wx.EXPAND, 0)
		sizer_84.Add(self.button_substate_str_straight, 0, wx.ALIGN_CENTER, 0)
		sizer_84.Add(self.button_substate_str_left, 0, wx.ALIGN_CENTER, 0)
		sizer_84.Add(self.button_substate_str_right, 0, wx.ALIGN_CENTER, 0)
		sizer_73.Add(sizer_84, 1, wx.ALIGN_CENTER | wx.EXPAND, 0)
		sizer_88.Add(self.button_substate_behav_lanechange_left, 0, wx.ALIGN_CENTER, 0)
		sizer_88.Add(self.button_substate_behav_lanechange_right, 0, wx.ALIGN_CENTER, 0)
		sizer_88.Add(self.button_substate_behav_obstacle_avoidance, 0, wx.ALIGN_CENTER, 0)
		sizer_88.Add(self.button_substate_behav_clear, 0, wx.ALIGN_CENTER, 0)
		sizer_73.Add(sizer_88, 1, 0, 0)
		sizer_89.Add(self.button_substate_percep_detect_obstacle, 0, wx.ALIGN_CENTER, 0)
		sizer_89.Add(self.button_substate_percep_detect_stop_line, 0, wx.ALIGN_CENTER, 0)
		sizer_89.Add(self.button_substate_percep_clear, 0, wx.ALIGN_CENTER, 0)
		sizer_89.Add(self.button_26, 0, wx.ALIGN_CENTER, 0)
		sizer_73.Add(sizer_89, 1, 0, 0)
		sizer_58.Add(sizer_73, 1, 0, 0)
		sizer_55.Add(sizer_58, 1, 0, 0)
		sizer_57.Add(self.current_state_label, 0, 0, 0)
		sizer_56.Add(sizer_57, 1, wx.ALL | wx.EXPAND, 0)
		sizer_55.Add(sizer_56, 1, wx.EXPAND, 0)
		sizer_50.Add(sizer_55, 1, wx.EXPAND, 0)
		self.panel_6.SetSizer(sizer_50)
		...
		self.notebook_1.AddPage(self.panel_6, _("State"))
...
class MyDialogLaneStop(wx.Dialog):
	...
	def __do_layout(self):
		...
		sizer_3.Add(self.button_red_light, 0, wx.ALIGN_CENTER | wx.ALL, 4)
		sizer_3.Add(self.button_green_light, 0, wx.ALIGN_CENTER | wx.ALL, 4)
		sizer_2.Add(sizer_3, 1, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 4)
		sizer_3_copy.Add(self.button_left_lane, 0, wx.ALIGN_CENTER | wx.ALL, 4)
		sizer_3_copy.Add(self.button_right_lane, 0, wx.ALIGN_CENTER | wx.ALL, 4)
