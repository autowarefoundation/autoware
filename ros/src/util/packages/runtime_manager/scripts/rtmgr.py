...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.8.0a9 on Fri Mar  2 15:11:48 2018
#
...
class MyFrame(wx.Frame):
	def __init__(self, *args, **kwds):
		...
		self.panel_gazebo_world = wx.Panel(self.tab_simulation, wx.ID_ANY)
	...
	def __do_layout(self):
		...
		sizer_50 = wx.StaticBoxSizer(wx.StaticBox(self.tab_states, wx.ID_ANY, _("State")), wx.HORIZONTAL)
		sizer_55 = wx.BoxSizer(wx.VERTICAL)
		sizer_58 = wx.StaticBoxSizer(wx.StaticBox(self.tab_states, wx.ID_ANY, _("SubState")), wx.HORIZONTAL)
		sizer_73 = wx.BoxSizer(wx.HORIZONTAL)
		sizer_91 = wx.StaticBoxSizer(wx.StaticBox(self.tab_states, wx.ID_ANY, _("Behavior")), wx.HORIZONTAL)
		sizer_93 = wx.BoxSizer(wx.VERTICAL)
		sizer_92 = wx.BoxSizer(wx.VERTICAL)
		sizer_84 = wx.StaticBoxSizer(wx.StaticBox(self.tab_states, wx.ID_ANY, _("Steering")), wx.VERTICAL)
		sizer_74 = wx.StaticBoxSizer(wx.StaticBox(self.tab_states, wx.ID_ANY, _("Accel/Brake")), wx.VERTICAL)
		grid_sizer_1 = wx.GridSizer(3, 2, 0, 0)
		sizer_65 = wx.StaticBoxSizer(wx.StaticBox(self.tab_states, wx.ID_ANY, _("MainState")), wx.HORIZONTAL)
		...
		sizer_36 = wx.StaticBoxSizer(wx.StaticBox(self.tab_topics, wx.ID_ANY, _("Info")), wx.HORIZONTAL)
		...
		sizer_stdout = wx.StaticBoxSizer(wx.StaticBox(self.tab_status, wx.ID_ANY, ""), wx.VERTICAL)
		sizer_38 = wx.BoxSizer(wx.HORIZONTAL)
		sizer_87 = wx.StaticBoxSizer(wx.StaticBox(self.panel_4, wx.ID_ANY, ""), wx.HORIZONTAL)
		sizer_86 = wx.StaticBoxSizer(wx.StaticBox(self.tab_status, wx.ID_ANY, ""), wx.HORIZONTAL)
		...
		sizer_79 = wx.StaticBoxSizer(wx.StaticBox(self.tab_simulation, wx.ID_ANY, ""), wx.VERTICAL)
		...
		sizer_26 = wx.StaticBoxSizer(wx.StaticBox(self.tab_interface, wx.ID_ANY, ""), wx.VERTICAL)
		...
		sizer_12 = wx.StaticBoxSizer(wx.StaticBox(self.tab_interface, wx.ID_ANY, ""), wx.VERTICAL)
		sizer_25 = wx.StaticBoxSizer(wx.StaticBox(self.tab_interface, wx.ID_ANY, ""), wx.HORIZONTAL)
		...
		sizer_94 = wx.StaticBoxSizer(wx.StaticBox(self.tab_sensing, wx.ID_ANY, ""), wx.VERTICAL)
		sizer_89 = wx.StaticBoxSizer(wx.StaticBox(self.tab_sensing, wx.ID_ANY, ""), wx.VERTICAL)
		sizer_33 = wx.BoxSizer(wx.VERTICAL)
		sizer_4 = wx.BoxSizer(wx.VERTICAL)
		sizer_62 = wx.BoxSizer(wx.HORIZONTAL)
		sizer_52_copy = wx.BoxSizer(wx.HORIZONTAL)
		sizer_39 = wx.StaticBoxSizer(wx.StaticBox(self.tab_map, wx.ID_ANY, _("Map Tools")), wx.VERTICAL)
		sizer_53_copy_3_copy_2_copy = wx.BoxSizer(wx.HORIZONTAL)
		sizer_53_copy_3_copy_2 = wx.BoxSizer(wx.HORIZONTAL)
		sizer_61 = wx.StaticBoxSizer(wx.StaticBox(self.tab_map, wx.ID_ANY, ""), wx.VERTICAL)
		...
		sizer_43_copy = wx.StaticBoxSizer(wx.StaticBox(self.tab_setup, wx.ID_ANY, _("Vehicle Info")), wx.HORIZONTAL)
		sizer_43 = wx.StaticBoxSizer(wx.StaticBox(self.tab_setup, wx.ID_ANY, _("Vehicle Model")), wx.HORIZONTAL)
		sizer_42 = wx.StaticBoxSizer(wx.StaticBox(self.tab_setup, wx.ID_ANY, _("Baselink to Localizer")), wx.HORIZONTAL)
		sizer_16 = wx.BoxSizer(wx.VERTICAL)
		sizer_51 = wx.BoxSizer(wx.HORIZONTAL)
		sizer_52 = wx.BoxSizer(wx.HORIZONTAL)
		sizer_60 = wx.BoxSizer(wx.HORIZONTAL)
		sizer_45 = wx.StaticBoxSizer(wx.StaticBox(self.tab_qs, wx.ID_ANY, ""), wx.VERTICAL)
		...
		sizer_47_copy.Add(self.panel_gazebo_world, 1, wx.ALIGN_CENTER_VERTICAL, 0)
		...
		self.sizer_topics_list.Add((0, 0), 0, 0, 0)
...
class MyDialogRosbagRecord(wx.Dialog):
	...
	def __do_layout(self):
		...
		self.sizer_topic.Add((0, 0), 0, 0, 0)
...
class MyDialogLaneStop(wx.Dialog):
	...
	def __do_layout(self):
		...
		sizer_30 = wx.BoxSizer(wx.VERTICAL)
		sizer_31 = wx.BoxSizer(wx.HORIZONTAL)
		sizer_47 = wx.StaticBoxSizer(wx.StaticBox(self, wx.ID_ANY, _("topic:/config/lane_stop")), wx.VERTICAL)
		self.sizer_v = wx.BoxSizer(wx.VERTICAL)
		sizer_2 = wx.BoxSizer(wx.HORIZONTAL)
		sizer_6 = wx.StaticBoxSizer(wx.StaticBox(self, wx.ID_ANY, _("Currnet Lane")), wx.VERTICAL)
		sizer_21_copy = wx.BoxSizer(wx.HORIZONTAL)
		sizer_21 = wx.BoxSizer(wx.HORIZONTAL)
		sizer_3_copy = wx.StaticBoxSizer(wx.StaticBox(self, wx.ID_ANY, _("Lane Change")), wx.VERTICAL)
		sizer_3 = wx.StaticBoxSizer(wx.StaticBox(self, wx.ID_ANY, _("Traffic Light")), wx.VERTICAL)
