...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.6.8 on Mon Jul  6 15:19:50 2015
#
...
class MyFrame(wx.Frame):
	def __init__(self, *args, **kwds):
		...
		self.tree_ctrl_data = wx.TreeCtrl(self.tab_viewer, wx.ID_ANY, style=wx.TR_HAS_BUTTONS | wx.TR_NO_LINES | wx.TR_DEFAULT_STYLE | wx.SUNKEN_BORDER)
		self.button_refresh_data = wx.Button(self.tab_viewer, wx.ID_ANY, _("Refresh"))
		self.text_ctrl_query = wx.TextCtrl(self.tab_viewer, wx.ID_ANY, _("sentence"))
		self.button_query = wx.Button(self.tab_viewer, wx.ID_ANY, _("Query"))
		self.list_ctrl_sql = wx.ListCtrl(self.tab_viewer, wx.ID_ANY, style=wx.LC_REPORT | wx.SUNKEN_BORDER)
		self.button_refresh = wx.Button(self.tab_viewer, wx.ID_ANY, _("Refresh"))
	...
	def __do_layout(self):
		...
		self.tab_viewer.SetSizer(sizer_10)
		...
		self.notebook_1.AddPage(self.tab_simulation, _("old"))
		self.notebook_1.AddPage(self.tab_viewer, _("Simulation"))
		self.notebook_1.AddPage(self.tab_main, _("Viewer"))
