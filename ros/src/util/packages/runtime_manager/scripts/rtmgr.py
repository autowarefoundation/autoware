...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.7.1 on Wed Nov 15 11:04:48 2017
#
...
class MyFrame(wx.Frame):
	def __init__(self, *args, **kwds):
		...
		# Configure the OnClose event
		self.Bind(wx.EVT_CLOSE, self.OnClose)
		
		# Configure persistence
        # Very important step!!
		if self.GetName() == "frame":
			self.SetName("rtmgr_persistence") # Do not use the default name!!
		if self.notebook_1.GetName() == "notebook":
			self.notebook_1.SetName("rtmgr_notebook_persistence") # Do not use the default name!!

		_configFile = self.my_src_dir() + 'rtmgr_persistence.ini'
		self._persistMgr = PM.PersistenceManager.Get()
		# self._persistMgr.SetManagerStyle(PM.PM_SAVE_RESTORE_AUI_PERSPECTIVES|PM.PM_SAVE_RESTORE_TREE_LIST_SELECTIONS|PM.PM_PERSIST_CONTROL_VALUE)
		self._persistMgr.SetPersistenceFile(_configFile)
		self._persistMgr.RegisterAndRestoreAll(self)
		self._persistMgr.Restore(self.notebook_1)
	...
	def save_persistence(self):
		...
		self._persistMgr.Save(self.notebook_1)
		self._persistMgr.Unregister(self)
	...
	def __set_properties(self):
		...
		self.label_map_qs.SetMinSize((100, 25))
