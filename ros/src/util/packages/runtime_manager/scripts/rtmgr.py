...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.6.8 on Thu Dec  4 19:55:21 2014
#
...
class MyFrame(wx.Frame):
	def __init__(self, *args, **kwds):
		...
		self.button_statchk_d = wx.Button(self.notebook_1_pane_1, wx.ID_ANY, _("D"))
		self.button_statchk_r = wx.Button(self.notebook_1_pane_1, wx.ID_ANY, _("R"))
		self.button_statchk_b = wx.Button(self.notebook_1_pane_1, wx.ID_ANY, _("B"))
		self.button_statchk_n = wx.Button(self.notebook_1_pane_1, wx.ID_ANY, _("N"))
		self.button_statchk_prog = wx.Button(self.notebook_1_pane_1, wx.ID_ANY, _("Program"))
		self.button_statchk_manu = wx.Button(self.notebook_1_pane_1, wx.ID_ANY, _("Manual"))
		...
		self.Bind(wx.EVT_BUTTON, self.OnGear, self.button_statchk_d)
		self.Bind(wx.EVT_BUTTON, self.OnGear, self.button_statchk_r)
		self.Bind(wx.EVT_BUTTON, self.OnGear, self.button_statchk_b)
		self.Bind(wx.EVT_BUTTON, self.OnGear, self.button_statchk_n)
		self.Bind(wx.EVT_BUTTON, self.OnProg, self.button_statchk_prog)
		self.Bind(wx.EVT_BUTTON, self.OnManu, self.button_statchk_manu)
	...
	def OnProg(self, event):  # wxGlade: MyFrame.<event_handler>
		print "Event handler 'OnProg' not implemented!"
		event.Skip()

	def OnManu(self, event):  # wxGlade: MyFrame.<event_handler>
		print "Event handler 'OnManu' not implemented!"
		event.Skip()
