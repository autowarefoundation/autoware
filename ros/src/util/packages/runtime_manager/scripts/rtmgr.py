...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.6.8 on Thu Feb 19 14:17:18 2015
#
...
class MyFrame(wx.Frame):
	def __init__(self, *args, **kwds):
		...
		self.button_tablet = wx.Button(self.notebook_1_pane_1, wx.ID_ANY, "")
		...
		self.button_mobile = wx.Button(self.notebook_1_pane_1, wx.ID_ANY, "")
		...
		self.button_vehicle = wx.Button(self.notebook_1_pane_1, wx.ID_ANY, "")
		...
		self.button_database = wx.Button(self.notebook_1_pane_1, wx.ID_ANY, "")
		...
		self.sizer_51_staticbox = wx.StaticBox(self.notebook_1_pane_1, wx.ID_ANY, _("Control Check"))
		...
		self.button_read_navi = wx.ToggleButton(self.notebook_1_pane_1, wx.ID_ANY, _("Read Navi"))
		self.button_load_map = wx.ToggleButton(self.notebook_1_pane_1, wx.ID_ANY, _("Load Map"))
		...
		self.button_ready = wx.Button(self.notebook_1_pane_1, wx.ID_ANY, _("Ready"))
		self.button_go = wx.Button(self.notebook_1_pane_1, wx.ID_ANY, _("Go"))
		...
		self.label_7_copy_copy = wx.StaticText(self.notebook_1_pane_4, wx.ID_ANY, _("Database IP"))
		self.text_ctrl_ip_d_0 = wx.TextCtrl(self.notebook_1_pane_4, wx.ID_ANY, "")
		self.label_4_copy_6_copy = wx.StaticText(self.notebook_1_pane_4, wx.ID_ANY, _("."))
		self.text_ctrl_ip_d_1 = wx.TextCtrl(self.notebook_1_pane_4, wx.ID_ANY, "")
		self.label_4_copy_copy_4_copy = wx.StaticText(self.notebook_1_pane_4, wx.ID_ANY, _("."))
		self.text_ctrl_ip_d_2 = wx.TextCtrl(self.notebook_1_pane_4, wx.ID_ANY, "")
		self.label_4_copy_1_copy_4_copy = wx.StaticText(self.notebook_1_pane_4, wx.ID_ANY, _("."))
		self.text_ctrl_ip_d_3 = wx.TextCtrl(self.notebook_1_pane_4, wx.ID_ANY, "")
		self.button_conn_d = wx.Button(self.notebook_1_pane_4, wx.ID_ANY, _("Connect"))
		self.button_disconn_d = wx.Button(self.notebook_1_pane_4, wx.ID_ANY, _("Disconnect"))
		self.label_7 = wx.StaticText(self.notebook_1_pane_4, wx.ID_ANY, _("lat"))
		self.label_8 = wx.StaticText(self.notebook_1_pane_4, wx.ID_ANY, _("lon"))
		self.label_7_copy_1 = wx.StaticText(self.notebook_1_pane_4, wx.ID_ANY, _("lat"))
		self.label_8_copy = wx.StaticText(self.notebook_1_pane_4, wx.ID_ANY, _("lon"))
		...
		self.checkbox_map_matching = wx.CheckBox(self.notebook_1_pane_4, wx.ID_ANY, _("Map Maching"))
		self.label_6 = wx.StaticText(self.notebook_1_pane_4, wx.ID_ANY, _("millisecond"))
		self.label_5 = wx.StaticText(self.notebook_1_pane_4, wx.ID_ANY, _("Rate:"))
		self.text_ctrl_rate_download = wx.TextCtrl(self.notebook_1_pane_4, wx.ID_ANY, "")
		self.button_launch_download = wx.Button(self.notebook_1_pane_4, wx.ID_ANY, _("Download"))
		self.button_kill_download = wx.Button(self.notebook_1_pane_4, wx.ID_ANY, _("Stop"))
		self.sizer_35_staticbox = wx.StaticBox(self.notebook_1_pane_4, wx.ID_ANY, _("In the Cloud"))
		self.label_6_copy_1 = wx.StaticText(self.notebook_1_pane_4, wx.ID_ANY, _("millisecond"))
		self.label_5_copy_1 = wx.StaticText(self.notebook_1_pane_4, wx.ID_ANY, _("Rate:"))
		self.text_ctrl_rate_upload = wx.TextCtrl(self.notebook_1_pane_4, wx.ID_ANY, "")
		self.button_launch_upload = wx.Button(self.notebook_1_pane_4, wx.ID_ANY, _("Upload"))
		self.button_kill_upload = wx.Button(self.notebook_1_pane_4, wx.ID_ANY, _("Stop"))
		self.sizer_35_copy_staticbox = wx.StaticBox(self.notebook_1_pane_4, wx.ID_ANY, _("On the Vehicle"))
		...
		self.text_ctrl_rate_rosbag_play = wx.TextCtrl(self.panel_3, wx.ID_ANY, "")
		...
		self.Bind(wx.EVT_BUTTON, self.OnNetConn, self.button_tablet)
		self.Bind(wx.EVT_BUTTON, self.OnNetConn, self.button_mobile)
		self.Bind(wx.EVT_BUTTON, self.OnNetConn, self.button_vehicle)
		self.Bind(wx.EVT_BUTTON, self.OnNetConn, self.button_database)
		...
		self.Bind(wx.EVT_BUTTON, self.OnMainButton, self.button_ready)
		self.Bind(wx.EVT_BUTTON, self.OnMainButton, self.button_go)
		self.Bind(wx.EVT_BUTTON, self.OnMainButton, self.button_pause)
		self.Bind(wx.EVT_BUTTON, self.OnMainButton, self.button_stop)
		...
		self.Bind(wx.EVT_BUTTON, self.OnLaunch, self.button_launch_download)
		self.Bind(wx.EVT_BUTTON, self.OnKill, self.button_kill_download)
		self.Bind(wx.EVT_BUTTON, self.OnLaunch, self.button_launch_upload)
		self.Bind(wx.EVT_BUTTON, self.OnKill, self.button_kill_upload)
		...
		self.Bind(wx.EVT_BUTTON, self.OnPause, self.button_pause_rosbag_play)
	...
	def __set_properties(self):
		...
		self.button_tablet.SetMinSize((26, 24))
		self.button_mobile.SetMinSize((26, 24))
		self.button_vehicle.SetMinSize((26, 24))
		self.button_database.SetMinSize((26, 24))
		...
		self.slider_statchk_accel.SetMinSize((160, 27))
		self.slider_statchk_steer.SetMinSize((160, 27))
		self.slider_statchk_brake.SetMinSize((160, 27))
		self.slider_statchk_veloc.SetMinSize((160, 27))
		...
		self.button_launch_download.Enable(False)
		self.button_kill_download.Enable(False)
		self.button_kill_upload.Enable(False)
	...
	def __do_layout(self):
		...
		self.sizer_35_copy_staticbox.Lower()
		sizer_35_copy = wx.StaticBoxSizer(self.sizer_35_copy_staticbox, wx.HORIZONTAL)
		sizer_37_copy = wx.BoxSizer(wx.VERTICAL)
		sizer_40_copy = wx.BoxSizer(wx.HORIZONTAL)
		sizer_38_copy = wx.BoxSizer(wx.HORIZONTAL)
		sizer_39_copy = wx.BoxSizer(wx.HORIZONTAL)
		self.sizer_on_the_vehicle = wx.BoxSizer(wx.VERTICAL)
		...
		self.sizer_51_staticbox.Lower()
		sizer_51 = wx.StaticBoxSizer(self.sizer_51_staticbox, wx.VERTICAL)
		...
		sizer_32.Add(sizer_34, 0, wx.EXPAND, 0)
		sizer_52.Add(sizer_32, 0, wx.EXPAND, 0)
		sizer_53.Add(self.label_12, 0, wx.ALIGN_CENTER_VERTICAL, 0)
		...
		sizer_52.Add(sizer_53, 0, wx.LEFT | wx.EXPAND, 4)
		sizer_51.Add(sizer_52, 0, wx.ALL | wx.EXPAND, 4)
		grid_sizer_2.Add(self.label_13_copy, 1, 0, 0)
		grid_sizer_2.Add(self.slider_statchk_accel, 0, wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 0)
		grid_sizer_2.Add(self.label_15_copy, 1, 0, 0)
		grid_sizer_2.Add(self.slider_statchk_steer, 0, wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 0)
		grid_sizer_2.Add(self.label_14_copy, 1, 0, 0)
		grid_sizer_2.Add(self.slider_statchk_brake, 0, wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 0)
		grid_sizer_2.Add(self.label_11, 0, wx.ALIGN_CENTER_VERTICAL, 0)
		grid_sizer_2.Add(self.slider_statchk_veloc, 1, wx.ALIGN_CENTER_VERTICAL, 0)
		sizer_51.Add(grid_sizer_2, 0, wx.ALL | wx.EXPAND, 4)
		sizer_46.Add(sizer_51, 1, wx.ALL, 4)
		...
		sizer_58.Add(self.button_ready, 0, wx.EXPAND, 0)
		sizer_58.Add(self.button_go, 0, wx.EXPAND, 0)
		...
		sizer_29.Add(self.label_7_copy_copy, 0, wx.ALIGN_CENTER_VERTICAL, 0)
		...
		sizer_29.Add(sizer_4_copy_4_copy, 0, wx.RIGHT | wx.ALIGN_CENTER_VERTICAL, 4)
		sizer_29.Add(self.button_conn_d, 0, wx.LEFT | wx.RIGHT | wx.ALIGN_CENTER_VERTICAL, 4)
		sizer_29.Add(self.button_disconn_d, 0, wx.LEFT | wx.RIGHT | wx.ALIGN_CENTER_VERTICAL, 4)
		sizer_23.Add(sizer_29, 0, wx.ALL | wx.EXPAND, 4)
		sizer_42.Add(self.label_7, 0, wx.LEFT, 70)
		sizer_42.Add(self.label_8, 0, wx.LEFT, 70)
		sizer_42.Add(self.label_7_copy_1, 0, wx.LEFT, 70)
		sizer_42.Add(self.label_8_copy, 0, wx.LEFT, 70)
		sizer_36.Add(sizer_42, 1, wx.EXPAND, 0)
		...
		sizer_36.Add(sizer_23_copy_1, 0, wx.ALL | wx.EXPAND, 4)
		sizer_36.Add(self.checkbox_map_matching, 0, 0, 0)
		sizer_35.Add(sizer_36, 0, wx.RIGHT | wx.EXPAND, 4)
		sizer_37.Add(self.label_6, 0, wx.LEFT, 40)
		sizer_39.Add(self.label_5, 0, wx.ALIGN_CENTER_VERTICAL, 0)
		sizer_39.Add(self.text_ctrl_rate_download, 0, wx.ALIGN_CENTER_VERTICAL, 0)
		sizer_38.Add(sizer_39, 1, wx.EXPAND, 0)
		sizer_37.Add(sizer_38, 1, wx.EXPAND, 0)
		sizer_40.Add(self.button_launch_download, 0, wx.ALIGN_CENTER_VERTICAL, 0)
		sizer_40.Add(self.button_kill_download, 0, wx.ALIGN_CENTER_VERTICAL, 0)
		sizer_37.Add(sizer_40, 1, wx.EXPAND, 0)
		sizer_35.Add(sizer_37, 0, wx.LEFT | wx.EXPAND, 4)
		sizer_23.Add(sizer_35, 0, wx.ALL | wx.EXPAND, 4)
		sizer_35_copy.Add(self.sizer_on_the_vehicle, 0, wx.EXPAND, 0)
		sizer_37_copy.Add(self.label_6_copy_1, 0, wx.LEFT, 40)
		sizer_39_copy.Add(self.label_5_copy_1, 0, wx.ALIGN_CENTER_VERTICAL, 0)
		sizer_39_copy.Add(self.text_ctrl_rate_upload, 0, wx.ALIGN_CENTER_VERTICAL, 0)
		sizer_38_copy.Add(sizer_39_copy, 1, wx.EXPAND, 0)
		sizer_37_copy.Add(sizer_38_copy, 1, wx.EXPAND, 0)
		sizer_40_copy.Add(self.button_launch_upload, 0, wx.ALIGN_CENTER_VERTICAL, 0)
		sizer_40_copy.Add(self.button_kill_upload, 0, wx.ALIGN_CENTER_VERTICAL, 0)
		sizer_37_copy.Add(sizer_40_copy, 1, wx.EXPAND, 0)
		sizer_35_copy.Add(sizer_37_copy, 0, wx.LEFT | wx.EXPAND, 4)
		sizer_23.Add(sizer_35_copy, 0, wx.ALL | wx.EXPAND, 4)
