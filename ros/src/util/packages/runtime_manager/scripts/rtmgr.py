...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.6.8 on Wed Dec  3 20:18:51 2014
#
...
class MyFrame(wx.Frame):
	def __init__(self, *args, **kwds):
		...
		self.text_ctrl_1_copy_7_copy = wx.TextCtrl(self.notebook_1_pane_1, wx.ID_ANY, "")
		self.label_4_copy_6_copy = wx.StaticText(self.notebook_1_pane_1, wx.ID_ANY, _("."))
		self.text_ctrl_1_copy_copy_4_copy = wx.TextCtrl(self.notebook_1_pane_1, wx.ID_ANY, "")
		self.label_4_copy_copy_4_copy = wx.StaticText(self.notebook_1_pane_1, wx.ID_ANY, _("."))
		self.text_ctrl_1_copy_1_copy_4_copy = wx.TextCtrl(self.notebook_1_pane_1, wx.ID_ANY, "")
		self.label_4_copy_1_copy_4_copy = wx.StaticText(self.notebook_1_pane_1, wx.ID_ANY, _("."))
		self.text_ctrl_1_copy_2_copy_4_copy = wx.TextCtrl(self.notebook_1_pane_1, wx.ID_ANY, "")
		...
		self.button_1_copy_5_copy = wx.Button(self.notebook_1_pane_1, wx.ID_ANY, _("Connect"))
		...
		self.button_1_copy_2_copy_4_copy = wx.Button(self.notebook_1_pane_1, wx.ID_ANY, _("Disconnect"))
		self.label_1 = wx.StaticText(self.notebook_1_pane_1, wx.ID_ANY, _("State Check"))
		self.button_9_copy = wx.Button(self.notebook_1_pane_1, wx.ID_ANY, _("D"))
		self.button_10_copy = wx.Button(self.notebook_1_pane_1, wx.ID_ANY, _("R"))
		self.button_12_copy = wx.Button(self.notebook_1_pane_1, wx.ID_ANY, _("B"))
		self.button_13_copy = wx.Button(self.notebook_1_pane_1, wx.ID_ANY, _("N"))
		self.button_11_copy = wx.Button(self.notebook_1_pane_1, wx.ID_ANY, _("Program"))
		self.button_14_copy = wx.Button(self.notebook_1_pane_1, wx.ID_ANY, _("Manual"))
	...
	def __set_properties(self):
		...
		self.button_9_copy.SetMinSize((29, 29))
		self.button_10_copy.SetMinSize((29, 29))
		self.button_12_copy.SetMinSize((29, 29))
		self.button_13_copy.SetMinSize((29, 29))
	...
	def __do_layout(self):
		...
		sizer_4_copy_4_copy.Add(self.text_ctrl_1_copy_7_copy, 0, 0, 0)
		sizer_4_copy_4_copy.Add(self.label_4_copy_6_copy, 0, 0, 0)
		sizer_4_copy_4_copy.Add(self.text_ctrl_1_copy_copy_4_copy, 0, 0, 0)
		sizer_4_copy_4_copy.Add(self.label_4_copy_copy_4_copy, 0, 0, 0)
		sizer_4_copy_4_copy.Add(self.text_ctrl_1_copy_1_copy_4_copy, 0, 0, 0)
		sizer_4_copy_4_copy.Add(self.label_4_copy_1_copy_4_copy, 0, 0, 0)
		sizer_4_copy_4_copy.Add(self.text_ctrl_1_copy_2_copy_4_copy, 0, 0, 0)
		...
		sizer_22_copy_1.Add(self.button_1_copy_5_copy, 1, 0, 0)
		...
		sizer_22_copy_2.Add(self.button_1_copy_2_copy_4_copy, 1, wx.EXPAND, 0)
		...
		sizer_33.Add(self.button_9_copy, 1, wx.EXPAND, 0)
		sizer_33.Add(self.button_10_copy, 1, wx.EXPAND, 0)
		sizer_33.Add(self.button_12_copy, 1, wx.EXPAND, 0)
		sizer_33.Add(self.button_13_copy, 1, wx.EXPAND, 0)
		sizer_32.Add(sizer_33, 1, wx.EXPAND, 0)
		sizer_34.Add(self.button_11_copy, 1, wx.EXPAND, 0)
		sizer_34.Add(self.button_14_copy, 1, wx.EXPAND, 0)
