...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.6.8 on Fri Jan 16 21:52:27 2015
#
...
class MyFrame(wx.Frame):
	def __init__(self, *args, **kwds):
		...
		self.text_ctrl_calibration = wx.TextCtrl(self.notebook_1_pane_5, wx.ID_ANY, "")
		self.button_ref_calibration = wx.Button(self.notebook_1_pane_5, wx.ID_ANY, _("Ref"))
		...
		self.Bind(wx.EVT_BUTTON, self.OnConnTablet, self.button_conn_b)
		...
		self.Bind(wx.EVT_BUTTON, self.OnRef, self.button_ref_calibration)
	...
	def __set_properties(self):
		...
		self.button_ref_calibration.SetMinSize((40, 29))
	...
	def __do_layout(self):
		...
		sizer_28_copy_1.Add(self.text_ctrl_calibration, 1, wx.LEFT | wx.TOP, 4)
		sizer_28_copy_1.Add(self.button_ref_calibration, 0, wx.LEFT | wx.RIGHT | wx.TOP, 4)
	...
	def OnConnTablet(self, event):  # wxGlade: MyFrame.<event_handler>
		print "Event handler 'OnConnTablet' not implemented!"
		event.Skip()
