...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.7.1 on Wed Dec 19 12:52:15 2018
#
...
class MyFrame(wx.Frame):
	def __init__(self, *args, **kwds):
		...
		self.button_lgsvl_sim = wx.ToggleButton(self.tab_simulation, wx.ID_ANY, _("LGSVL_SIM"))
	...
	def __do_layout(self):
		...
		.Add(self.button_gazebo, 0, wx.ALL, 4)
		.Add(self.button_lgsvl_sim, 0, wx.ALL, 4)
		sizer_62_copy_copy_copy_copy_copy.Add(, 1, wx.EXPAND, 0)
