...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.7.1 on Fri Apr 20 18:37:49 2018
#
...
class MyFrame(wx.Frame):
	def __init__(self, *args, **kwds):
		...
		self.panel_6 = wx.Panel(self.tab_interface, wx.ID_ANY)
		self.button_android_tablet_interface = wx.ToggleButton(self.panel_6, wx.ID_ANY, _("Android Tablet"))
		self.button_oculus_rift_interface = wx.ToggleButton(self.panel_6, wx.ID_ANY, _("Oculus Rift"))
		self.button_vehicle_gateway_interface = wx.ToggleButton(self.panel_6, wx.ID_ANY, _("Vehicle Gateway"))
		self.button_remote_control_interface = wx.ToggleButton(self.panel_6, wx.ID_ANY, _("Remote Control"))
		self.sizer_25_staticbox = wx.StaticBox(self.panel_6, wx.ID_ANY, "")
		self.checkbox_sound = wx.CheckBox(self.panel_6, wx.ID_ANY, _("Sound"))
		self.sizer_12_staticbox = wx.StaticBox(self.panel_6, wx.ID_ANY, "")
		self.button_auto_pilot_interface_hidden = wx.ToggleButton(self.panel_6, wx.ID_ANY, _("Auto Pilot"))
		self.label_5 = wx.StaticText(self.panel_6, wx.ID_ANY, _("Lamp"))
		self.button_statchk_lamp_l = wx.ToggleButton(self.panel_6, wx.ID_ANY, _("L"))
		self.button_statchk_lamp_r = wx.ToggleButton(self.panel_6, wx.ID_ANY, _("R"))
		self.label_5_copy = wx.StaticText(self.panel_6, wx.ID_ANY, _("Indicator"))
		self.button_statchk_indi_l = wx.ToggleButton(self.panel_6, wx.ID_ANY, _("L"))
		self.button_statchk_indi_r = wx.ToggleButton(self.panel_6, wx.ID_ANY, _("R"))
		self.button_statchk_d = wx.ToggleButton(self.panel_6, wx.ID_ANY, _("D"))
		self.button_statchk_r = wx.ToggleButton(self.panel_6, wx.ID_ANY, _("R"))
		self.button_statchk_b = wx.ToggleButton(self.panel_6, wx.ID_ANY, _("B"))
		self.button_statchk_n = wx.ToggleButton(self.panel_6, wx.ID_ANY, _("N"))
		self.panel_interface_cc = wx.Panel(self.panel_6, wx.ID_ANY)
		self.sizer_26_staticbox = wx.StaticBox(self.panel_6, wx.ID_ANY, "")
		self.button_auto_pilot_interface = wx.ToggleButton(self.tab_interface, wx.ID_ANY, _("Auto Pilot"))
		self.button_on_ndt_init = wx.Button(self.tab_interface, wx.ID_ANY, _("Init NDT"))
		self.button_route01 = wx.ToggleButton(self.tab_interface, wx.ID_ANY, _("Route01"))
		self.button_route02 = wx.ToggleButton(self.tab_interface, wx.ID_ANY, _("Route02"))
		self.apex_report_custom = wx.TextCtrl(self.tab_interface, wx.ID_ANY, "")
		self.apex_report_text = wx.ListBox(self.tab_interface, wx.ID_ANY, choices=[])
		self.apex_report_button = wx.Button(self.tab_interface, wx.ID_ANY, _("Send"))
		self.button_rosbag_toggle = wx.ToggleButton(self.tab_interface, wx.ID_ANY, _("Recording"))
		self.button_substate_acc_4_copy = wx.Button(self.tab_interface, wx.ID_ANY, _("Keep"))
		self.button_substate_acc_5_copy = wx.Button(self.tab_interface, wx.ID_ANY, _("Stop"))
		self.button_run_all_sensors = wx.Button(self.tab_interface, wx.ID_ANY, _("Run AllSensors"))
		self.button_run_lidar_tracker = wx.Button(self.tab_interface, wx.ID_ANY, _("Run LidarTracker"))
		self.button_run_ros1_bridge = wx.Button(self.tab_interface, wx.ID_ANY, _("Run ROS1 Bridge"))
		...
		self.Bind(wx.EVT_TOGGLEBUTTON, self.OnAutoPilot, self.button_auto_pilot_interface_hidden)
		...
		self.Bind(wx.EVT_BUTTON, self.OnInitNDT, self.button_on_ndt_init)
		self.Bind(wx.EVT_TOGGLEBUTTON, self.OnRoute01, self.button_route01)
		self.Bind(wx.EVT_TOGGLEBUTTON, self.OnRoute02, self.button_route02)
		self.Bind(wx.EVT_TEXT, self.OnApexReportCustom, self.apex_report_custom)
		self.Bind(wx.EVT_LISTBOX, self.OnApexReportSelected, self.apex_report_text)
		self.Bind(wx.EVT_BUTTON, self.OnApexReportSend, self.apex_report_button)
		self.Bind(wx.EVT_TOGGLEBUTTON, self.OnRosbagToggle, self.button_rosbag_toggle)
		self.Bind(wx.EVT_BUTTON, self.OnState, self.button_substate_acc_4_copy)
		self.Bind(wx.EVT_BUTTON, self.OnState, self.button_substate_acc_5_copy)
		self.Bind(wx.EVT_BUTTON, self.OnRunAllSensors, self.button_run_all_sensors)
		self.Bind(wx.EVT_BUTTON, self.OnRunLidarTracker, self.button_run_lidar_tracker)
		self.Bind(wx.EVT_BUTTON, self.OnRunROS1Bridge, self.button_run_ros1_bridge)
	...
	def __set_properties(self):
		...
		self.button_android_tablet_interface.Hide()
		self.button_oculus_rift_interface.Hide()
		self.button_vehicle_gateway_interface.Hide()
		self.button_remote_control_interface.Hide()
		self.checkbox_sound.Hide()
		self.button_auto_pilot_interface_hidden.Hide()
		self.label_5.Hide()
		self.button_statchk_lamp_l.SetMinSize((32, 29))
		self.button_statchk_lamp_l.Hide()
		self.button_statchk_lamp_r.SetMinSize((32, 29))
		self.button_statchk_lamp_r.Hide()
		self.label_5_copy.Hide()
		self.button_statchk_indi_l.SetMinSize((32, 29))
		self.button_statchk_indi_l.Hide()
		self.button_statchk_indi_r.SetMinSize((32, 29))
		self.button_statchk_indi_r.Hide()
		self.button_statchk_d.SetMinSize((32, 29))
		self.button_statchk_d.Hide()
		self.button_statchk_r.SetMinSize((32, 29))
		self.button_statchk_r.Hide()
		self.button_statchk_b.SetMinSize((32, 29))
		self.button_statchk_b.Hide()
		self.button_statchk_n.SetMinSize((32, 29))
		self.button_statchk_n.Hide()
		self.panel_interface_cc.Hide()
		self.panel_6.Hide()
	...
	def __do_layout(self):
		...
		grid_sizer_2 = wx.GridSizer(2, 3, 2, 2)
		sizer_57 = wx.BoxSizer(wx.VERTICAL)
		grid_sizer_3 = wx.GridSizer(3, 2, 2, 2)
		sizer_88 = wx.BoxSizer(wx.VERTICAL)
		...
		sizer_69.Add(self.button_calibration_toolkit, 1, wx.ALIGN_CENTER_HORIZONTAL | wx.ALL | wx.EXPAND, 4)
		sizer_69.Add(self.button_calibration_publisher, 1, wx.ALIGN_CENTER_HORIZONTAL | wx.ALL | wx.EXPAND, 4)
		sizer_7.Add(sizer_69, 2, wx.EXPAND | wx.TOP, 8)
		sizer_70.Add(self.button_points_image, 1, wx.ALIGN_CENTER_HORIZONTAL | wx.ALL | wx.EXPAND, 4)
		sizer_70.Add(self.button_virtual_scan_image, 1, wx.ALIGN_CENTER_HORIZONTAL | wx.ALL | wx.EXPAND, 4)
		sizer_70.Add(self.button_scan_image, 1, wx.ALIGN_CENTER_HORIZONTAL | wx.ALL | wx.EXPAND, 4)
		sizer_7.Add(sizer_70, 3, wx.BOTTOM | wx.EXPAND | wx.TOP, 8)
		...
		sizer_88.Add(sizer_9, 1, wx.EXPAND, 0)
		sizer_72.Add(self.button_auto_pilot_interface_hidden, 1, wx.ALL | wx.EXPAND, 4)
		...
		sizer_88.Add(sizer_26, 0, wx.ALL | wx.EXPAND, 4)
		self.panel_6.SetSizer(sizer_88)
		sizer_24.Add(self.panel_6, 1, 0, 0)
		grid_sizer_2.Add(self.button_auto_pilot_interface, 1, wx.ALL | wx.EXPAND, 4)
		grid_sizer_3.Add(self.button_on_ndt_init, 1, wx.ALL | wx.EXPAND, 4)
		grid_sizer_3.Add((20, 20), 0, wx.EXPAND, 0)
		grid_sizer_3.Add(self.button_route01, 1, wx.ALL | wx.EXPAND, 4)
		grid_sizer_3.Add((20, 20), 0, wx.EXPAND, 0)
		grid_sizer_3.Add(self.button_route02, 1, wx.ALL | wx.EXPAND, 4)
		grid_sizer_2.Add(grid_sizer_3, 1, wx.EXPAND, 0)
		sizer_57.Add(self.apex_report_custom, 0, wx.EXPAND, 0)
		sizer_57.Add(self.apex_report_text, 1, wx.EXPAND, 0)
		sizer_57.Add(self.apex_report_button, 0, wx.ALIGN_CENTER | wx.ALL, 0)
		grid_sizer_2.Add(sizer_57, 1, wx.EXPAND, 0)
		grid_sizer_2.Add(self.button_rosbag_toggle, 1, wx.ALL | wx.EXPAND, 4)
		grid_sizer_2.Add(self.button_substate_acc_4_copy, 1, wx.ALL | wx.EXPAND, 4)
		grid_sizer_2.Add(self.button_substate_acc_5_copy, 1, wx.ALL | wx.EXPAND, 4)
		sizer_24.Add(grid_sizer_2, 1, wx.EXPAND, 0)
		sizer_62_copy_copy_copy.Add(self.button_run_all_sensors, 1, wx.ALL, 0)
		sizer_62_copy_copy_copy.Add(self.button_run_lidar_tracker, 1, wx.ALL, 0)
		sizer_62_copy_copy_copy.Add(self.button_run_ros1_bridge, 1, wx.ALL, 0)
	...
	def OnInitNDT(self, event):  # wxGlade: MyFrame.<event_handler>
		print "Event handler 'OnInitNDT' not implemented!"
		event.Skip()

	def OnRoute01(self, event):  # wxGlade: MyFrame.<event_handler>
		print "Event handler 'OnRoute01' not implemented!"
		event.Skip()

	def OnRoute02(self, event):  # wxGlade: MyFrame.<event_handler>
		print "Event handler 'OnRoute02' not implemented!"
		event.Skip()

	def OnApexReportCustom(self, event):  # wxGlade: MyFrame.<event_handler>
		print "Event handler 'OnApexReportCustom' not implemented!"
		event.Skip()

	def OnApexReportSelected(self, event):  # wxGlade: MyFrame.<event_handler>
		print "Event handler 'OnApexReportSelected' not implemented!"
		event.Skip()

	def OnApexReportSend(self, event):  # wxGlade: MyFrame.<event_handler>
		print "Event handler 'OnApexReportSend' not implemented!"
		event.Skip()

	def OnRosbagToggle(self, event):  # wxGlade: MyFrame.<event_handler>
		print "Event handler 'OnRosbagToggle' not implemented!"
		event.Skip()
	...
	def OnRunAllSensors(self, event):  # wxGlade: MyFrame.<event_handler>
		print "Event handler 'OnRunAllSensors' not implemented!"
		event.Skip()

	def OnRunLidarTracker(self, event):  # wxGlade: MyFrame.<event_handler>
		print "Event handler 'OnRunLidarTracker' not implemented!"
		event.Skip()

	def OnRunROS1Bridge(self, event):  # wxGlade: MyFrame.<event_handler>
		print "Event handler 'OnRunROS1Bridge' not implemented!"
		event.Skip()
...
class MyDialogRosbagRecord(wx.Dialog):
	def __init__(self, *args, **kwds):
		...
		self.button_save_preset = wx.Button(self, wx.ID_ANY, _("Save preset"))
		...
		self.Bind(wx.EVT_BUTTON, self.OnSavePreset, self.button_save_preset)
		# end wxGlade
	...
	def __do_layout(self):
		...
		sizer_41.Add(self.button_save_preset, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 4)
	...
	def OnSavePreset(self, event):  # wxGlade: MyDialogRosbagRecord.<event_handler>
		print "Event handler 'OnSavePreset' not implemented!"
		event.Skip()
