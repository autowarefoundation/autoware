...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.6.8 on Wed Jul  8 19:31:19 2015
#
...
class MyFrame(wx.Frame):
	def __init__(self, *args, **kwds):
		...
		self.label_top_cmd = wx.StaticText(self.panel_3, wx.ID_ANY, _("top -----------------------------------------------------------------\na\nb\nc"))
	...
	def __do_layout(self):
		...
		sizer_60.Add((0, 50), 0, wx.EXPAND, 0)
		sizer_60.Add(self.label_cpuinfo_qs, 1, wx.ALL | wx.EXPAND, 4)
		...
		sizer_60_copy.Add((0, 50), 0, 0, 0)
		sizer_60_copy.Add(self.label_cpuinfo_status, 1, wx.ALL | wx.EXPAND, 4)
