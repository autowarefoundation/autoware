...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.6.8 on Thu Apr 16 18:35:03 2015
#
...
class MyFrame(wx.Frame):
	def __init__(self, *args, **kwds):
		...
		self.button_init = wx.ToggleButton(self.notebook_1_pane_1, wx.ID_ANY, _("Init"))
		self.button_check = wx.ToggleButton(self.notebook_1_pane_1, wx.ID_ANY, _("Check"))
		self.button_set = wx.ToggleButton(self.notebook_1_pane_1, wx.ID_ANY, _("Set"))
		...
		self.Bind(wx.EVT_TOGGLEBUTTON, self.OnMainButton, self.button_init)
		self.Bind(wx.EVT_TOGGLEBUTTON, self.OnMainButton, self.button_check)
		self.Bind(wx.EVT_TOGGLEBUTTON, self.OnMainButton, self.button_set)
	...
	def __do_layout(self):
		...
		sizer_7.Add(sizer_25_copy_copy_1, 0, wx.TOP | wx.BOTTOM | wx.EXPAND, 40)
...
class MyDialogNdtSlam(wx.Dialog):
	def __init__(self, *args, **kwds):
		...
		kwds["style"] = wx.DEFAULT_DIALOG_STYLE
		wx.Dialog.__init__(self, *args, **kwds)
		self.label_2 = wx.StaticText(self, wx.ID_ANY, _("Map Resolution:"))
		self.text_ctrl_map_resolution = wx.TextCtrl(self, wx.ID_ANY, "")
		self.button_3 = wx.Button(self, wx.ID_ANY, _("PCD OUTPUT"))
		self.button_2 = wx.Button(self, wx.ID_ANY, _("OK"))
	...
	def __do_layout(self):
		...
		sizer_45.Add(self.label_2, 0, wx.LEFT | wx.RIGHT | wx.ALIGN_CENTER_VERTICAL, 4)
		sizer_45.Add(self.text_ctrl_map_resolution, 0, wx.LEFT | wx.RIGHT | wx.ALIGN_CENTER_VERTICAL, 4)
		sizer_45.Add(self.button_3, 0, wx.LEFT | wx.ALIGN_CENTER_VERTICAL, 40)
		sizer_16.Add(sizer_45, 1, wx.EXPAND, 0)
		sizer_16.Add(self.button_2, 0, wx.ALL | wx.ALIGN_CENTER_HORIZONTAL, 4)
