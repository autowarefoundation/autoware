...
void FastVirtualScan::calculateVirtualScans(int beamNum, double heightStep, double minFloor, double maxCeiling,
                                            double obstacleMinHeight, double maxBackDistance, double beamRotation,
                                            double minRange)
{
      ...
      for (j = 0; j < size; j++)
      {
        ...
        else if (svs[i][j].rotlength < MAXVIRTUALSCAN)
        {
          if (svs[i][j].height - svs[i][startid].height < obstacleMinHeight &&
              svs[i][j].rotlength - svs[i][startid].rotlength > -maxBackDistance)
          {
...
void FastVirtualScan::getVirtualScan(double thetaminheight, double thetamaxheight, double maxFloor, double minCeiling,
                                     double passHeight, QVector<double> &virtualScan)
{
