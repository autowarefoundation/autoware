...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_ROSTFPub_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
...
const QMetaObject ROSTFPub::staticMetaObject = {
    { &ROSInterfaceBase::staticMetaObject, qt_meta_stringdata_ROSTFPub.data,
      qt_meta_data_ROSTFPub,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ROSTFPub.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_ROSTFSub_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
...
QT_MOC_LITERAL(9, 135, 13)
    ...
    "stopReceiveSlot\0receiveTFSlot\0"
};
#undef QT_MOC_LITERAL
...
const QMetaObject ROSTFSub::staticMetaObject = {
    { &ROSInterfaceBase::staticMetaObject, qt_meta_stringdata_ROSTFSub.data,
      qt_meta_data_ROSTFSub,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ROSTFSub.stringdata))
