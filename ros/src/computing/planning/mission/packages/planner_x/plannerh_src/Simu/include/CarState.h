...
public:
	...
	void CalculateImportantParameterForDecisionMaking(const std::vector<PlannerHNS::Obstacle>& obj_list, const PlannerHNS::VehicleState& car_state, const PlannerHNS::GPSPoint& goal);
