...
#include "autoware_planning_msgs/State.h"
...
private:
  ...
  std::vector<std::tuple<autoware_planning_msgs::Lane, int32_t, ChangeFlag>> tuple_vec_;  // lane, closest_waypoint,
                                                                                 // change_flag
  std::tuple<autoware_planning_msgs::Lane, int32_t, ChangeFlag> lane_for_change_;
  ...
  // callbacks
  void callbackFromLaneArray(const autoware_planning_msgs::LaneArrayConstPtr &msg);
  ...
  void callbackFromStates(const autoware_planning_msgs::StateConstPtr &msg);
  ...
  void processing();
  void publishLane(const autoware_planning_msgs::Lane &lane);
  void publishLaneID(const autoware_planning_msgs::Lane &lane);
  ...
  int32_t getClosestLaneChangeWaypointNumber(const std::vector<autoware_planning_msgs::Waypoint> &wps, int32_t cl_wp);
};
