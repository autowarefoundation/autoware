...
public:
  ...
  ros::Subscriber vehicle_location_sub = nh.subscribe("/vehicle_location", 1, &LaneSelectTestClass::vehicleLocationCallback, this);
  ...
  void vehicleLocationCallback(const autoware_msgs::VehicleLocationConstPtr& msg)
  {
    ...
    std::cout << "vehicleLocationCallback: " << cb_vehicle_location.waypoint_index << ", " << cb_vehicle_location.lane_array_id << std::endl;
  }
