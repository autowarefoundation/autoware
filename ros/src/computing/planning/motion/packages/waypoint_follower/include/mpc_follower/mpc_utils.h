 ...
 * @param index index vector related to object value (Eigen::Vector or std::vector)
 * @param values object value vector (Eigen::Vector or std::vector)
 * @param ref reference index
 * @param ret interpolated value
 ...
 * @param index index vector related to MPCTrajectory value 
 * @param values MPCTrajectory
 * @param ref reference index
 * @param ret interpolated MPCTrajectory
 * @return bool to check whether it was interpolated properly  
 */
 ...
 * @param traj object trajectory
 * @param curvature_smoothing_num index distance for 3 points for curvature calculation
 */
void calcTrajectoryCurvature(MPCTrajectory &traj, int curvature_smoothing_num);

/**
 * @brief convert waypoints to MPCTrajectory
 * @param path input waypoints
 * @param mpc_traj converted traj
 */
 ...
 * @param path input waypoints 
 * @param path_time waypoints time used for MPCTrajectory relative_time
 * @param d_ref_index distance of reference index
 * @param ref_traj converted reference trajectory
 */
 ...
 * @param path input waypoints 
 * @param path_time waypoints time used for MPCTrajectory relative_time
 * @param dl distance of interpolated path
 * @param ref_traj converted reference trajectory
 */
 ...
 * @param path input waypoints 
 * @param path_time waypoints time used for MPCTrajectory relative_time
 * @param dt time span of interpolated path
 * @param ref_traj converted reference trajectory
 */
 ...
 * @param path object waypoints
 * @param path_time calculated waypoints time vector
 */
 ...
 * @param self_pose object pose 
 * @param nearest_pose nearest pose on path
 * @param nearest_index path index of nearest pose 
 * @param min_dist_error distance error from nearest pose to self pose
 * @param nearest_yaw_error yaw angle error from nearest pose to self pose
 * @param nearest_time time of nearest pose on trajectory
