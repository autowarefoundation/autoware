...
//	std::vector<std::vector<WayPoint> > m_PredictedPath;
  ...
  void SetSimulatedTargetOdometryReadings(
...
public:
  ...
  void Init(
    const ControllerParams & ctrlParams, const PlanningParams & params,
