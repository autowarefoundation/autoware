...
void SimulatedTrajectoryFollower::Init(
...
{
  m_CurrPos = CurPos;
  FindNextWayPoint(m_Path, m_CurrPos, currVelocity, m_FollowMePoint, m_PerpendicularPoint,
    m_LateralError, m_FollowingDistance);
}
