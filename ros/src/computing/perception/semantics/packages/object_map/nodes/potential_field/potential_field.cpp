...
private:
  ...
  void obj_callback(autoware_detection_msgs::DetectedObjectArray::ConstPtr obj_msg);
...
void PotentialField::obj_callback(
    autoware_detection_msgs::DetectedObjectArray::ConstPtr obj_msg) { // Create grid map.
