...
std::vector<boost_polygon> Nms(const std::vector<std::vector<float> > &,
                               const float &);
...
std::vector<float> keep_elements_less_than(const float &,
                                           const std::vector<float> &);

std::vector<float> keep_elements_larger_than(const float &,
                                             const std::vector<float> &);
