...
TEST(UKF, checkPredictionForSUKF)
{
  ...
  // std::cerr << "x " << ukf.x_ctrv_(0, 0) << std::endl;
  // std::cerr << "k " << ukf.k_ctrv_(0, 0) << std::endl;
...
//   bool is_fault = ukf.faultDetection(MotionModel::CTRV);
...
//   EXPECT_NEAR(-12.554539, test_x_ctrv_0, 0.00001);
//   EXPECT_NEAR(0.011001, test_p_ctrv_1, 0.00001);
// }
//
