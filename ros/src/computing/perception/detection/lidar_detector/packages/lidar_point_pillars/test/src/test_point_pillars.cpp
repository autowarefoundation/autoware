...
public:
  ...
  void loadPoints(pcl::PointCloud<pcl::PointXYZI>::Ptr in_pcl_pc_ptr,
...
void TestClass::loadPoints(pcl::PointCloud<pcl::PointXYZI>::Ptr in_pcl_pc_ptr,
                           const std::string& in_file )
{
...
TEST(TestSuite, CheckPreprocessPointsCPU)
{
  ...
  test_obj.preprocess(points_array, pcl_pc_ptr->size(),
                      x_coors, y_coors, num_points_per_pillar,
                      pillar_x, pillar_y, pillar_z, pillar_i,
                      x_coors_for_sub_shaped, y_coors_for_sub_shaped,
                      pillar_feature_mask, sparse_pillar_map, host_pillar_count);
