...
void PreprocessPoints::initializeVariables(int* coor_to_pillaridx, float* sparse_pillar_map,
...
void PreprocessPoints::preprocess(const float* in_points_array, int in_num_points,
