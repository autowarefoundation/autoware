...
extern void resizeLaunchUsingTex(IplImage* img, float scale, size_t type, CvLSVMFeatureMapGPU* dev_out,
                                 CUstream stream);

extern void resizeGPUStream(const int numStep, IplImage* img, float* scale, CvLSVMFeatureMapGPU** devs_img,
                            CUstream* stream);
