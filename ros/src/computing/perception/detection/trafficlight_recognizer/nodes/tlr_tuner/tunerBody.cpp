...
void TunerBody::launch(void)
{
  ...
  ros::Publisher tunedResult_pub = n.advertise <autoware_detection_msgs::TunedResult> ("tuned_result", ADVERTISE_QUEUE_SIZE, ADVERTISE_LATCH);
  ...
  while (ros::ok())
    {
      ...
      autoware_detection_msgs::TunedResult res;
