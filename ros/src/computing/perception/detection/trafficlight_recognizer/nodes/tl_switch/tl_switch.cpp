...
private:
  ...
  void camera_light_color_callback(
      const autoware_detection_msgs::TrafficLight::ConstPtr &input_msg);
  ...
  autoware_detection_msgs::TrafficLight camera_msg_;
  autoware_detection_msgs::TrafficLight ams_msg_;
  autoware_detection_msgs::TrafficLight state_msg_;
  ros::NodeHandle nh_;
...
TLSwitch::TLSwitch(const ros::NodeHandle &nh, const ros::NodeHandle &private_nh)
  ...
  traffic_light_pub_ = nh_.advertise<autoware_detection_msgs::TrafficLight>(
...
void TLSwitch::camera_light_color_callback(
    const autoware_detection_msgs::TrafficLight::ConstPtr &msg) {
