...
DataRateCheckerPlugin::DataRateCheckerPlugin(QWidget* parent) : rviz::Panel(parent)
{
  // Initialize form
  ui_.setupUi(this);
...
void DataRateCheckerPlugin::on_topic_combo_box__activated(int index)
{
  ...
  topic_sub_ = node_handle_.subscribe(selected_topic, 1000, &DataRateCheckerPlugin::MessageCallback, this);

  timer_ = node_handle_.createWallTimer(ros::WallDuration(1.0), &DataRateCheckerPlugin::TimerCallback, this);
