...
#include "autoware_localization_msgs/ICPStat.h"
...
static autoware_localization_msgs::ICPStat icp_stat_msg;
...
int main(int argc, char** argv)
{
  ...
  icp_stat_pub = nh.advertise<autoware_localization_msgs::ICPStat>("/icp_stat", 1000);
