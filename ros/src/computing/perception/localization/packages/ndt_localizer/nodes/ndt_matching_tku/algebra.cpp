...
int eigenvalue_matrix3d(double mat[3][3],double l1[2], double l2[2],double l3[2]){
  ...
  c =   -mat[0][0]*mat[1][1]*mat[2][2] - 2* mat[0][1]*mat[0][2]*mat[1][2]
    +mat[0][0]*mat[1][2]*mat[1][2]+ mat[1][1]*mat[0][2]*mat[0][2] +mat[2][2]*mat[0][1]*mat[0][1];
...
/*eigen vecter*/
int eigenvecter_matrix2d(double mat[2][2],
...
/*eigen vecter*/
int eigenvecter_matrix3d(double mat[3][3],
			 double v[3][3],
			 double *l)
{
  double L[3][3],V[3][3];  
  ...
  if((i = jacobi_matrix3d(10000,0.0000000001,mat,L,V)) < 0)return -1;
...
int matrix2d_eigen(double *v1,double *v2,double l1,double l2,double dst[2][2]){
  ...
  if(!inverse_matrix2d(V,IV))return 0;
...
int matrix3d_eigen(double v[3][3],
		   double l1,double l2,double l3,double dst[3][3]){
  ...
  if(!inverse_matrix3d(v,IV))return 0;
...
int round_matrix3d(double mat[3][3],double dst[3][3]){
  ...
  if(v[0][0]*v[1][0]+v[0][1]*v[1][1]+v[0][2]*v[1][2] != 0)return 0;
  if(v[1][0]*v[2][0]+v[1][1]*v[2][1]+v[1][2]*v[2][2] != 0)return 0;
  if(v[2][0]*v[0][0]+v[2][1]*v[0][1]+v[2][2]*v[0][2] != 0)return 0;
