^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for package autoware_detection_msgs
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
* Update OpenPlanner libraries (op_planner, op_utitity, op_ros_helpers)
  ...
  Modify autoware_detection_msgs for OpenPlanner use (CloudCluster, DetectedObject, lane, waypoint)
...
* autoware_detection_msgs does not depend on jsk_rviz_plugin, cmake and package.xml were not correct
...
1.3.0 (2017-07-14)
------------------
* convert to autoware_detection_msgs
