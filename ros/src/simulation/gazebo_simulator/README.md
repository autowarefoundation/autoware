...
```
$ rosrun vehicle_gazebo_simulator_launcher setup.sh
```
...
```
$ roslaunch vehicle_gazebo_simulator_launcher gazebo7_citysim.launch gpu:=true
```
...
```
$ roslaunch vehicle_gazebo_simulator_launcher gazebo9_citysim.launch gpu:=true
```
...
```
$ roslaunch vehicle_gazebo_simulator_launcher gazebo_mcity.launch gpu:=true
```
...
```
$ roslaunch vehicle_gazebo_simulator_launcher gazebo_autoware.launch gpu:=true
```
