...
void publish_msg(cv_tracker::obj_label* p_obj_label_buf, autoware_detection_msgs::Centroids* p_cluster_centroids_buf)
{
    ROS_INFO("publish");
...
int main(int argc, char **argv) {
    ...
    cluster_centroids__pub = nh.advertise<autoware_detection_msgs::Centroids>("/cluster_centroids_", 5);
    while (!buf_flag) {
        ros::spinOnce();
        usleep(100000);
    }
