...
void* thread(void* args) {
    ...
    ros::Subscriber image_obj_ranged_sub = nh_rcv.subscribe("obj_car/image_obj_ranged", 5, image_obj_ranged_callback);
    while (nh_rcv.ok()) {
#if 1
    ROS_INFO("debug1");
#endif
...
int main(int argc, char **argv) {
    ...
    image_obj__pub = nh.advertise<autoware_detection_msgs::ImageObj>("obj_car/image_obj_", 5);
    vscan_image__pub = nh.advertise<autoware_sensing_msgs::PointsImage>("vscan_image_", 5);
