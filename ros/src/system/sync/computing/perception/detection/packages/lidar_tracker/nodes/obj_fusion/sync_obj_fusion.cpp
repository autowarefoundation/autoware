...
int main(int argc, char **argv) {
    ...
    Synchronizer<autoware_detection_msgs::ObjLabel, autoware_detection_msgs::Centroids, visualization_msgs::MarkerArray> synchronizer(sub1, sub2, pub1, pub2, req, ns);
    synchronizer.run();
...
boost::circular_buffer<autoware_detection_msgs::Centroids> cluster_centroids_ringbuf(10);
...
autoware_detection_msgs::Centroids* p_cluster_centroids_buf;

void publish_msg(autoware_detection_msgs::ObjLabel* p_obj_label_buf, autoware_detection_msgs::Centroids* p_cluster_centroids_buf)
{
    ROS_INFO("publish");
...
bool publish() {
    if (buf_flag) {
        ...
        // obj_label < cluster_centroids
            ...
            boost::circular_buffer<autoware_detection_msgs::Centroids>::iterator it = cluster_centroids_ringbuf.begin();
...
autoware_detection_msgs::Centroids cluster_centroids_buf;
...
int main(int argc, char **argv) {
    ...
    cluster_centroids__pub = nh.advertise<autoware_detection_msgs::Centroids>("/sync_obj_fusion/cluster_centroids", 5);
