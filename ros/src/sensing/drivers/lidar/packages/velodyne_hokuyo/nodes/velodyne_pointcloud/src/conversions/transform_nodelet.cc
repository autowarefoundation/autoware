...
{
  class vhTransformNodelet: public nodelet::Nodelet
  {
  public:
  ...
  void vhTransformNodelet::onInit()
  {
...
PLUGINLIB_DECLARE_CLASS(velodyne_pointcloud, vhTransformNodelet,
                        velodyne_pointcloud::vhTransformNodelet,
                        nodelet::Nodelet);
