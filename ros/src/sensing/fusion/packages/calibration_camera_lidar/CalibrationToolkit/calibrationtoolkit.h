...
class CalibrateCameraChessboardROS : public CalibrateCameraChessboardBase
{
  Q_OBJECT
public:
  CalibrateCameraChessboardROS(QString topic, u_int32_t queueSize, int interval, cv::Size2f patternSize,
...
class CalibrateCameraVelodyneChessboardBase : public CalibrateCameraChessboardBase
{
  Q_OBJECT
public:
  CalibrateCameraVelodyneChessboardBase(float maxRange, cv::Size2f patternSize, cv::Size2i patternNum,
                                        QWidget *parent = 0);
...
class CalibrateCameraVelodyneChessboardROS : public CalibrateCameraVelodyneChessboardBase
{
  Q_OBJECT
public:
  CalibrateCameraVelodyneChessboardROS(QString cameraTopic, u_int32_t cameraQueueSize, int cameraInterval,
...
class CalibrateCameraLidarChessboardBase : public CalibrateCameraChessboardBase
{
  Q_OBJECT
public:
  CalibrateCameraLidarChessboardBase(float maxRange, cv::Size2f patternSize, cv::Size2i patternNum,
                                     QWidget *parent = 0);
...
class CalibrateCameraLidarChessboardROS : public CalibrateCameraLidarChessboardBase
{
  Q_OBJECT
public:
  CalibrateCameraLidarChessboardROS(QString cameraTopic, u_int32_t cameraQueueSize, int cameraInterval,
                                    QString lidarTopic, u_int32_t lidarQueueSize, int lidarInterval, float maxRange,
                                    cv::Size2f patternSize, cv::Size2i patternNum, QWidget *parent = 0);
