...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_PlaneExtractor_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 39, 36),
QT_MOC_LITERAL(4, 76, 10),
QT_MOC_LITERAL(5, 87, 7),
QT_MOC_LITERAL(6, 95, 6),
QT_MOC_LITERAL(7, 102, 2),
...
QT_MOC_LITERAL(12, 160, 10)
    ...
    "CAMERAPARAMETERS*\0parameters\0"
};
...
const QMetaObject PlaneExtractor::staticMetaObject = {
    { &GLViewer::staticMetaObject, qt_meta_stringdata_PlaneExtractor.data,
      qt_meta_data_PlaneExtractor,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PlaneExtractor.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_PointsExtractor_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
...
QT_MOC_LITERAL(5, 68, 2)
    ...
    "\0QVector<QPointF>\0extraction\0id\0"
};
#undef QT_MOC_LITERAL
...
const QMetaObject PointsExtractor::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_PointsExtractor.data,
      qt_meta_data_PointsExtractor,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PointsExtractor.stringdata))
