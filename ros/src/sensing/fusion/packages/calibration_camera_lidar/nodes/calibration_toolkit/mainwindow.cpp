...
MainWindow::MainWindow(QWidget *parent) : QMainWindow(parent), ui(new Ui::MainWindow)
{
  ...
  QString selection =
      QInputDialog::getItem(this, "Choose Calibration Type", "Calibration Type",
                            QStringList() << CALIBCAMERA << CALIBCAMERAVELODYNE << CALIBCAMERA2DLIDAR, 0, 0);
  ...
  if (selection == CALIBCAMERA)
  {
    ...
    CalibrateCameraChessboardROS *calibration =
        new CalibrateCameraChessboardROS(cameratopic, 1000, 10, cvpatternsize, cvpatternnum);
  ...
  else if (selection == CALIBCAMERAVELODYNE)
  {
    ...
    CalibrateCameraVelodyneChessboardROS *calibration = new CalibrateCameraVelodyneChessboardROS(
        cameratopic, 1000, 10, velodynetopic, 1000, 10, 100, cvpatternsize, cvpatternnum);
  ...
  else if (selection == CALIBCAMERA2DLIDAR)
  {
    ...
    CalibrateCameraLidarChessboardROS *calibration = new CalibrateCameraLidarChessboardROS(
        cameratopic, 1000, 10, lidartopic, 1000, 10, 100, cvpatternsize, cvpatternnum);
