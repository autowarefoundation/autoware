...
if("TRUE" STREQUAL "TRUE")
  set(vlg22c_cam_SOURCE_PREFIX /home/hatem/autoware_openplanner/Autoware/ros/src/sensing/drivers/camera/packages/baumer)
  set(vlg22c_cam_DEVEL_PREFIX /home/hatem/autoware_openplanner/Autoware/ros/src/devel)
  ...
  set(vlg22c_cam_INSTALL_PREFIX /usr/local)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vlg22c_cam' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hatem/autoware_openplanner/Autoware/ros/src/sensing/drivers/camera/packages/baumer/${idir}'.  Ask the maintainer 'rbcar <aaa@aaa.com>' to fix it.")
    endif()
