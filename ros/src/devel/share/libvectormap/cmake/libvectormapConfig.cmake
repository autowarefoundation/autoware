...
if("TRUE" STREQUAL "TRUE")
  set(libvectormap_SOURCE_PREFIX /home/hatem/autoware_openplanner/Autoware/ros/src/computing/perception/detection/lib/libvectormap)
  set(libvectormap_DEVEL_PREFIX /home/hatem/autoware_openplanner/Autoware/ros/src/devel)
  ...
  set(libvectormap_INSTALL_PREFIX /usr/local)
...
if(NOT "/home/hatem/autoware_openplanner/Autoware/ros/src/computing/perception/detection/lib/libvectormap/include " STREQUAL " ")
  set(libvectormap_INCLUDE_DIRS "")
  set(_include_dirs "/home/hatem/autoware_openplanner/Autoware/ros/src/computing/perception/detection/lib/libvectormap/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'libvectormap' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'sujiwo <sujiwo@ertl.jp>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'libvectormap' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hatem/autoware_openplanner/Autoware/ros/src/computing/perception/detection/lib/libvectormap/${idir}'.  Ask the maintainer 'sujiwo <sujiwo@ertl.jp>' to fix it.")
    endif()
    _list_append_unique(libvectormap_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "vectormap")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${libvectormap_dep}_FOUND)
      find_package(${libvectormap_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${libvectormap_dep} REQUIRED ${depend_list})
  endif()
