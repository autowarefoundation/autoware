...
if("TRUE" STREQUAL "TRUE")
  set(lattice_planner_SOURCE_PREFIX /home/hatem/autoware_openplanner/Autoware/ros/src/computing/planning/motion/packages/lattice_planner)
  set(lattice_planner_DEVEL_PREFIX /home/hatem/autoware_openplanner/Autoware/ros/src/devel)
...
if(NOT "/home/hatem/autoware_openplanner/Autoware/ros/src/computing/planning/motion/packages/lattice_planner/include " STREQUAL " ")
  set(lattice_planner_INCLUDE_DIRS "")
  set(_include_dirs "/home/hatem/autoware_openplanner/Autoware/ros/src/computing/planning/motion/packages/lattice_planner/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lattice_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hatem/autoware_openplanner/Autoware/ros/src/computing/planning/motion/packages/lattice_planner/${idir}'.  Ask the maintainer 'mokelly <mokelly@seas.upenn.edu>' to fix it.")
    endif()
...
set(depends "roscpp;std_msgs;tf;waypoint_follower;vector_map;autoware_msgs;gnss")
