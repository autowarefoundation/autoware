...
if("TRUE" STREQUAL "TRUE")
  set(fusion_SOURCE_PREFIX /home/hatem/autoware-dev/Autoware/ros/src/computing/perception/detection/lib/fusion)
  set(fusion_DEVEL_PREFIX /home/hatem/autoware-dev/Autoware/ros/src/devel)
  set(fusion_INSTALL_PREFIX "")
  set(fusion_PREFIX ${fusion_DEVEL_PREFIX})
else()
  set(fusion_SOURCE_PREFIX "")
  set(fusion_DEVEL_PREFIX "")
  set(fusion_INSTALL_PREFIX /usr/local)
...
if(NOT "/home/hatem/autoware-dev/Autoware/ros/src/computing/perception/detection/lib/fusion/include " STREQUAL " ")
  set(fusion_INCLUDE_DIRS "")
  set(_include_dirs "/home/hatem/autoware-dev/Autoware/ros/src/computing/perception/detection/lib/fusion/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'fusion' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Masao KONDOH <kondoh@axe-inc.co.jp>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'fusion' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hatem/autoware-dev/Autoware/ros/src/computing/perception/detection/lib/fusion/${idir}'.  Ask the maintainer 'Masao KONDOH <kondoh@axe-inc.co.jp>' to fix it.")
    endif()
    _list_append_unique(fusion_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "fusion")
...
set(depends "roscpp;scan2image;points2image")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${fusion_dep}_FOUND)
      find_package(${fusion_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${fusion_dep} REQUIRED ${depend_list})
  endif()
