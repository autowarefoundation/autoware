...
if("TRUE" STREQUAL "TRUE")
  set(state_machine_SOURCE_PREFIX /home/hatem/autoware_openplanner/Autoware/ros/src/computing/planning/state/state_machine)
  set(state_machine_DEVEL_PREFIX /home/hatem/autoware_openplanner/Autoware/ros/src/devel)
  ...
  set(state_machine_INSTALL_PREFIX /usr/local)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'state_machine' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Hiroki OHTA <h_ohta@ertl.jp>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'state_machine' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hatem/autoware_openplanner/Autoware/ros/src/computing/planning/state/state_machine/${idir}'.  Ask the maintainer 'Hiroki OHTA <h_ohta@ertl.jp>' to fix it.")
    endif()
...
set(depends "roscpp;geometry_msgs;autoware_msgs")
