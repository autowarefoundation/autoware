...
if("TRUE" STREQUAL "TRUE")
  set(state_machine_SOURCE_PREFIX /home/hatem/autoware-dev/Autoware/ros/src/computing/planning/state/state_machine)
  set(state_machine_DEVEL_PREFIX /home/hatem/autoware-dev/Autoware/ros/src/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'state_machine' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hatem/autoware-dev/Autoware/ros/src/computing/planning/state/state_machine/${idir}'.  Ask the maintainer 'Hiroki OHTA <h_ohta@ertl.jp>' to fix it.")
    endif()
...
set(depends "roscpp;geometry_msgs;runtime_manager")
