...
if("TRUE" STREQUAL "TRUE")
  set(libdpm_ocv_SOURCE_PREFIX /home/hatem/autoware_openplanner/Autoware/ros/src/computing/perception/detection/lib/image/dpm_ocv)
  set(libdpm_ocv_DEVEL_PREFIX /home/hatem/autoware_openplanner/Autoware/ros/src/devel)
...
if(NOT "/home/hatem/autoware_openplanner/Autoware/ros/src/computing/perception/detection/lib/image/dpm_ocv/include/dpm_ocv " STREQUAL " ")
  set(libdpm_ocv_INCLUDE_DIRS "")
  set(_include_dirs "/home/hatem/autoware_openplanner/Autoware/ros/src/computing/perception/detection/lib/image/dpm_ocv/include/dpm_ocv")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'libdpm_ocv' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Yusuke Fujii <yusuke.fujii@tier4.jp>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'libdpm_ocv' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hatem/autoware_openplanner/Autoware/ros/src/computing/perception/detection/lib/image/dpm_ocv/${idir}'.  Ask the maintainer 'Yusuke Fujii <yusuke.fujii@tier4.jp>' to fix it.")
    endif()
...
set(libdpm_ocv_EXPORTED_TARGETS "")
