...
if("TRUE" STREQUAL "TRUE")
  set(velodyne_driver_SOURCE_PREFIX /home/hatem/autoware_openplanner/Autoware/ros/src/sensing/drivers/lidar/packages/velodyne/velodyne_driver)
  set(velodyne_driver_DEVEL_PREFIX /home/hatem/autoware_openplanner/Autoware/ros/src/devel)
...
if(NOT "/home/hatem/autoware_openplanner/Autoware/ros/src/sensing/drivers/lidar/packages/velodyne/velodyne_driver/include " STREQUAL " ")
  set(velodyne_driver_INCLUDE_DIRS "")
  set(_include_dirs "/home/hatem/autoware_openplanner/Autoware/ros/src/sensing/drivers/lidar/packages/velodyne/velodyne_driver/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'velodyne_driver' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Jack O'Quin <jack.oquin@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'velodyne_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hatem/autoware_openplanner/Autoware/ros/src/sensing/drivers/lidar/packages/velodyne/velodyne_driver/${idir}'.  Ask the maintainer 'Jack O'Quin <jack.oquin@gmail.com>' to fix it.")
    endif()
