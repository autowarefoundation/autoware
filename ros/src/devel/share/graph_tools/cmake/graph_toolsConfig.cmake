...
if("TRUE" STREQUAL "TRUE")
  set(graph_tools_SOURCE_PREFIX /home/hatem/autoware_openplanner/Autoware/ros/src/util/packages/graph_tools)
  set(graph_tools_DEVEL_PREFIX /home/hatem/autoware_openplanner/Autoware/ros/src/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'graph_tools' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hatem/autoware_openplanner/Autoware/ros/src/util/packages/graph_tools/${idir}'.  Ask the maintainer 'usuda <usuda@axe.bz>' to fix it.")
    endif()
