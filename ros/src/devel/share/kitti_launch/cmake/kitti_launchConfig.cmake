...
if("TRUE" STREQUAL "TRUE")
  set(kitti_launch_SOURCE_PREFIX /home/hatem/autoware_openplanner/Autoware/ros/src/util/packages/kitti_pkg/kitti_launch)
  set(kitti_launch_DEVEL_PREFIX /home/hatem/autoware_openplanner/Autoware/ros/src/devel)
  ...
  set(kitti_launch_INSTALL_PREFIX /usr/local)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'kitti_launch' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'hoshika <hoshika@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'kitti_launch' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hatem/autoware_openplanner/Autoware/ros/src/util/packages/kitti_pkg/kitti_launch/${idir}'.  Ask the maintainer 'hoshika <hoshika@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${kitti_launch_dep}_FOUND)
      find_package(${kitti_launch_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${kitti_launch_dep} REQUIRED ${depend_list})
  endif()
