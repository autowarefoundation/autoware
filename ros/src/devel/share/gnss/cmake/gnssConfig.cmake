...
if("TRUE" STREQUAL "TRUE")
  set(gnss_SOURCE_PREFIX /home/hatem/autoware_openplanner/Autoware/ros/src/computing/perception/localization/lib/gnss)
  set(gnss_DEVEL_PREFIX /home/hatem/autoware_openplanner/Autoware/ros/src/devel)
...
if(NOT "/home/hatem/autoware_openplanner/Autoware/ros/src/computing/perception/localization/lib/gnss/include/gnss " STREQUAL " ")
  set(gnss_INCLUDE_DIRS "")
  set(_include_dirs "/home/hatem/autoware_openplanner/Autoware/ros/src/computing/perception/localization/lib/gnss/include/gnss")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'gnss' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Tomomi HORII <tomo@axe.bz>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'gnss' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hatem/autoware_openplanner/Autoware/ros/src/computing/perception/localization/lib/gnss/${idir}'.  Ask the maintainer 'Tomomi HORII <tomo@axe.bz>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${gnss_dep}_FOUND)
      find_package(${gnss_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${gnss_dep} REQUIRED ${depend_list})
  endif()
