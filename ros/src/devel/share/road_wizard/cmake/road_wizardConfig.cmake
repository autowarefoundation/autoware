...
if("TRUE" STREQUAL "TRUE")
  set(road_wizard_SOURCE_PREFIX /home/hatem/autoware_openplanner/Autoware/ros/src/computing/perception/detection/packages/road_wizard)
  set(road_wizard_DEVEL_PREFIX /home/hatem/autoware_openplanner/Autoware/ros/src/devel)
...
if(NOT "/usr/include/eigen3 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'road_wizard' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hatem/autoware_openplanner/Autoware/ros/src/computing/perception/detection/packages/road_wizard/${idir}'.  Ask the maintainer 'Manato HIRABAYASHI <hirabayashi@ertl.jp>' to fix it.")
    endif()
...
set(road_wizard_EXPORTED_TARGETS "")
...
set(depends "std_msgs;message_runtime;geometry_msgs;vector_map_server;libvectormap;autoware_msgs")
