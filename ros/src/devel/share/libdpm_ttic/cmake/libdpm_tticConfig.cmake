...
if("TRUE" STREQUAL "TRUE")
  set(libdpm_ttic_SOURCE_PREFIX /home/user/Autoware/Autoware/ros/src/computing/perception/detection/lib/image/dpm_ttic)
  set(libdpm_ttic_DEVEL_PREFIX /home/user/Autoware/Autoware/ros/src/devel)
...
if(NOT "/home/user/Autoware/Autoware/ros/src/computing/perception/detection/lib/image/dpm_ttic/include/dpm_ttic " STREQUAL " ")
  set(libdpm_ttic_INCLUDE_DIRS "")
  set(_include_dirs "/home/user/Autoware/Autoware/ros/src/computing/perception/detection/lib/image/dpm_ttic/include/dpm_ttic")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'libdpm_ttic' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/user/Autoware/Autoware/ros/src/computing/perception/detection/lib/image/dpm_ttic/${idir}'.  Ask the maintainer 'Syohei YOSHIDA <syoshida@axe.bz>' to fix it.")
    endif()
