...
if("TRUE" STREQUAL "TRUE")
  set(vel_pose_mux_SOURCE_PREFIX /home/user/Autoware/Autoware/ros/src/computing/perception/localization/packages/vel_pose_mux)
  set(vel_pose_mux_DEVEL_PREFIX /home/user/Autoware/Autoware/ros/src/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vel_pose_mux' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/user/Autoware/Autoware/ros/src/computing/perception/localization/packages/vel_pose_mux/${idir}'.  Ask the maintainer 'h_ohta <h_ohta@ertl.jp>' to fix it.")
    endif()
