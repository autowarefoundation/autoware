...
if("TRUE" STREQUAL "TRUE")
  set(autoware_msgs_SOURCE_PREFIX /home/hatem/autoware_openplanner/Autoware/ros/src/msgs/autoware_msgs)
  set(autoware_msgs_DEVEL_PREFIX /home/hatem/autoware_openplanner/Autoware/ros/src/devel)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'autoware_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Yusuke Fujii <yusuke.fujii@tier4.jp>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'autoware_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hatem/autoware_openplanner/Autoware/ros/src/msgs/autoware_msgs/${idir}'.  Ask the maintainer 'Yusuke Fujii <yusuke.fujii@tier4.jp>' to fix it.")
    endif()
...
set(autoware_msgs_EXPORTED_TARGETS "autoware_msgs_generate_messages_cpp;autoware_msgs_generate_messages_eus;autoware_msgs_generate_messages_lisp;autoware_msgs_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${autoware_msgs_dep}_FOUND)
      find_package(${autoware_msgs_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${autoware_msgs_dep} REQUIRED ${depend_list})
  endif()
