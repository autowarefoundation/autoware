...
if("TRUE" STREQUAL "TRUE")
  set(vector_map_server_SOURCE_PREFIX /home/hatem/autoware_openplanner/Autoware/ros/src/data/packages/vector_map_server)
  set(vector_map_server_DEVEL_PREFIX /home/hatem/autoware_openplanner/Autoware/ros/src/devel)
...
if(NOT "/home/hatem/autoware_openplanner/Autoware/ros/src/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vector_map_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hatem/autoware_openplanner/Autoware/ros/src/data/packages/vector_map_server/${idir}'.  Ask the maintainer 'syouji <syouji@axe.bz>' to fix it.")
    endif()
...
set(depends "message_runtime;roscpp;geometry_msgs;autoware_msgs;vector_map_msgs;vector_map")
