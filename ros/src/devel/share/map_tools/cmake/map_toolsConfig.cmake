...
if("TRUE" STREQUAL "TRUE")
  set(map_tools_SOURCE_PREFIX /home/hatem/autoware_openplanner/Autoware/ros/src/util/packages/map_tools)
  set(map_tools_DEVEL_PREFIX /home/hatem/autoware_openplanner/Autoware/ros/src/devel)
  ...
  set(map_tools_INSTALL_PREFIX /usr/local)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'map_tools' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'kitsukawa <yuki@ertl.jp>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'map_tools' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hatem/autoware_openplanner/Autoware/ros/src/util/packages/map_tools/${idir}'.  Ask the maintainer 'kitsukawa <yuki@ertl.jp>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${map_tools_dep}_FOUND)
      find_package(${map_tools_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${map_tools_dep} REQUIRED ${depend_list})
  endif()
