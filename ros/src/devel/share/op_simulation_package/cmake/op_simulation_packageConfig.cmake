...
if("TRUE" STREQUAL "TRUE")
  set(op_simulation_package_SOURCE_PREFIX /home/hatem/autoware_openplanner/Autoware/ros/src/computing/planning/motion/packages/op_simulation_package)
  set(op_simulation_package_DEVEL_PREFIX /home/hatem/autoware_openplanner/Autoware/ros/src/devel)
  ...
  set(op_simulation_package_INSTALL_PREFIX /usr/local)
...
if(NOT "/home/hatem/autoware_openplanner/Autoware/ros/src/computing/planning/motion/packages/op_simulation_package/include " STREQUAL " ")
  set(op_simulation_package_INCLUDE_DIRS "")
  set(_include_dirs "/home/hatem/autoware_openplanner/Autoware/ros/src/computing/planning/motion/packages/op_simulation_package/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'op_simulation_package' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Yusuke FUJII <yusuke.fujii@tier4.jp>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'op_simulation_package' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hatem/autoware_openplanner/Autoware/ros/src/computing/planning/motion/packages/op_simulation_package/${idir}'.  Ask the maintainer 'Yusuke FUJII <yusuke.fujii@tier4.jp>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${op_simulation_package_dep}_FOUND)
      find_package(${op_simulation_package_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${op_simulation_package_dep} REQUIRED ${depend_list})
  endif()
