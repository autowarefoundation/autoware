...
if("TRUE" STREQUAL "TRUE")
  set(vehicle_socket_SOURCE_PREFIX /home/hatem/autoware_openplanner/Autoware/ros/src/socket/packages/vehicle_socket)
  set(vehicle_socket_DEVEL_PREFIX /home/hatem/autoware_openplanner/Autoware/ros/src/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vehicle_socket' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hatem/autoware_openplanner/Autoware/ros/src/socket/packages/vehicle_socket/${idir}'.  Ask the maintainer 'h_ohta <h_ohta@ertl.jp>' to fix it.")
    endif()
...
set(depends "roscpp;std_msgs;autoware_msgs")
