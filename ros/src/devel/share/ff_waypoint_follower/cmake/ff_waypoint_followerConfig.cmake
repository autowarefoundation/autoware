...
if("TRUE" STREQUAL "TRUE")
  set(ff_waypoint_follower_SOURCE_PREFIX /home/hatem/autoware_openplanner/Autoware/ros/src/computing/planning/motion/packages/ff_waypoint_follower)
  set(ff_waypoint_follower_DEVEL_PREFIX /home/hatem/autoware_openplanner/Autoware/ros/src/devel)
...
if(NOT "/home/hatem/autoware_openplanner/Autoware/ros/src/computing/planning/motion/packages/ff_waypoint_follower/include " STREQUAL " ")
  set(ff_waypoint_follower_INCLUDE_DIRS "")
  set(_include_dirs "/home/hatem/autoware_openplanner/Autoware/ros/src/computing/planning/motion/packages/ff_waypoint_follower/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ff_waypoint_follower' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Yusuke FUJII <yusuke.fujii@tier4.jp>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'ff_waypoint_follower' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hatem/autoware_openplanner/Autoware/ros/src/computing/planning/motion/packages/ff_waypoint_follower/${idir}'.  Ask the maintainer 'Yusuke FUJII <yusuke.fujii@tier4.jp>' to fix it.")
    endif()
...
set(depends "roscpp;geometry_msgs;runtime_manager;map_file;op_utility;op_planner;op_simu;waypoint_follower")
