...
if("TRUE" STREQUAL "TRUE")
  set(freespace_planner_SOURCE_PREFIX /home/user/Autoware/Autoware/ros/src/computing/planning/mission/packages/freespace_planner)
  set(freespace_planner_DEVEL_PREFIX /home/user/Autoware/Autoware/ros/src/devel)
  ...
  set(freespace_planner_INSTALL_PREFIX /usr/local)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'freespace_planner' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Tomomi HORII <tomo@axe-inc.co.jp>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'freespace_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/user/Autoware/Autoware/ros/src/computing/planning/mission/packages/freespace_planner/${idir}'.  Ask the maintainer 'Tomomi HORII <tomo@axe-inc.co.jp>' to fix it.")
    endif()
...
set(depends "tablet_socket;waypoint_follower;runtime_manager;gnss")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${freespace_planner_dep}_FOUND)
      find_package(${freespace_planner_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${freespace_planner_dep} REQUIRED ${depend_list})
  endif()
