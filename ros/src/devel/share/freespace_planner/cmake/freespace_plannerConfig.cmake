...
if("TRUE" STREQUAL "TRUE")
  set(freespace_planner_SOURCE_PREFIX /home/hatem/autoware_openplanner/Autoware/ros/src/computing/planning/mission/packages/freespace_planner)
  set(freespace_planner_DEVEL_PREFIX /home/hatem/autoware_openplanner/Autoware/ros/src/devel)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'freespace_planner' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Tomohito ANDO <antm678@ertl.jp>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'freespace_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hatem/autoware_openplanner/Autoware/ros/src/computing/planning/mission/packages/freespace_planner/${idir}'.  Ask the maintainer 'Tomohito ANDO <antm678@ertl.jp>' to fix it.")
    endif()
