...
if("TRUE" STREQUAL "TRUE")
  set(ndt_localizer_SOURCE_PREFIX /home/hatem/autoware_openplanner/Autoware/ros/src/computing/perception/localization/packages/ndt_localizer)
  set(ndt_localizer_DEVEL_PREFIX /home/hatem/autoware_openplanner/Autoware/ros/src/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ndt_localizer' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hatem/autoware_openplanner/Autoware/ros/src/computing/perception/localization/packages/ndt_localizer/${idir}'.  Ask the maintainer 'kitsukawa <yuki@ertl.jp>' to fix it.")
    endif()
...
set(depends "std_msgs;velodyne_pointcloud;autoware_msgs;filters;registration;ndt_tku")
