...
if("TRUE" STREQUAL "TRUE")
  set(ndt_localizer_SOURCE_PREFIX /home/user/Autoware/Autoware/ros/src/computing/perception/localization/packages/ndt_localizer)
  set(ndt_localizer_DEVEL_PREFIX /home/user/Autoware/Autoware/ros/src/devel)
  ...
  set(ndt_localizer_INSTALL_PREFIX /usr/local)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ndt_localizer' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'kitsukawa <yuki@ertl.jp>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'ndt_localizer' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/user/Autoware/Autoware/ros/src/computing/perception/localization/packages/ndt_localizer/${idir}'.  Ask the maintainer 'kitsukawa <yuki@ertl.jp>' to fix it.")
    endif()
...
set(ndt_localizer_EXPORTED_TARGETS "ndt_localizer_generate_messages_cpp;ndt_localizer_generate_messages_eus;ndt_localizer_generate_messages_lisp;ndt_localizer_generate_messages_py")
...
set(depends "runtime_manager;message_runtime;std_msgs;velodyne_pointcloud")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${ndt_localizer_dep}_FOUND)
      find_package(${ndt_localizer_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${ndt_localizer_dep} REQUIRED ${depend_list})
  endif()
  ...
  list(APPEND ndt_localizer_EXPORTED_TARGETS ${${ndt_localizer_dep}_EXPORTED_TARGETS})
endforeach()
