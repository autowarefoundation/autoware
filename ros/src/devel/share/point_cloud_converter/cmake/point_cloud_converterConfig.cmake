...
if("TRUE" STREQUAL "TRUE")
  set(point_cloud_converter_SOURCE_PREFIX /home/hatem/autoware_openplanner/Autoware/ros/src/system/gazebo/point_cloud_converter)
  set(point_cloud_converter_DEVEL_PREFIX /home/hatem/autoware_openplanner/Autoware/ros/src/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'point_cloud_converter' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hatem/autoware_openplanner/Autoware/ros/src/system/gazebo/point_cloud_converter/${idir}'.  Ask the maintainer 'Sammy Pfeiffer <sam.pfeiffer@pal-robotics.com>' to fix it.")
    endif()
