...
if("TRUE" STREQUAL "TRUE")
  set(points_downsampler_SOURCE_PREFIX /home/hatem/autoware_openplanner/Autoware/ros/src/sensing/filters/packages/points_downsampler)
  set(points_downsampler_DEVEL_PREFIX /home/hatem/autoware_openplanner/Autoware/ros/src/devel)
...
if(NOT "/home/hatem/autoware_openplanner/Autoware/ros/src/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'points_downsampler' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hatem/autoware_openplanner/Autoware/ros/src/sensing/filters/packages/points_downsampler/${idir}'.  Ask the maintainer 'Yuki KITSUKAWA <yuki@ertl.jp>' to fix it.")
    endif()
