...
public class DrawCenterView extends View{
	...
	public void drawView(int num){
		...
		topShader = new  LinearGradient(SoundManagementActivity.viewWidth, SoundManagementActivity.viewHeight, SoundManagementActivity.viewWidth, SoundManagementActivity.viewHeight/50, Color.RED, Color.BLACK,  Shader.TileMode.CLAMP);  
		bottomShader = new  LinearGradient(SoundManagementActivity.viewWidth, 0, SoundManagementActivity.viewWidth, SoundManagementActivity.viewHeight - SoundManagementActivity.viewHeight/50, Color.RED, Color.BLACK,  Shader.TileMode.CLAMP);  
